(function($) {
    ...
    const defaultToolbar = "styleselect | bold italic | image link | emoticons | table | bullist numlist";
    ...
    Mavo.Elements.register(".tinymce", {
        ...
        edit: function() {
            (this.preEdit || Promise.resolve()).then((v)=>{
                ...
                tinymce.init({
                    ...
                    menubar: false,
                    toolbar,
                    plugins: Array.from(plugins).join(" ")
                }).then((editors)=>{
            ...
            if (this.element.tinymce) tinymce.EditorManager.execCommand("mceRemoveEditor", true, this.element.tinymce.id);
        },
        getValue: (element)=>{
        ...
        setValue: (element, value)=>{
            ...
            if (!element.tinymce) element.innerHTML = content;
            else if (element.tinymce.isHidden()) element.tinymce.setContent(content);
        }
    });
})(Bliss);

//# sourceMappingURL=index.78e804b4.js.map
