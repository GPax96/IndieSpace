!function() {
    ...
    function e(t, r, i) {
        ...
        if ("string" === o) {
            ...
            !s || s.writable && s.configurable && s.enumerable && !s.get && !s.set ? t[i] = r[i] : (delete t[i], Object.defineProperty(t, i, s));
        } else if ("array" === o) i.forEach(function(n) {
            n in r && e(t, r, n);
        });
        else for(var a in r)i && ("regexp" === o && !i.test(a) || "function" === o && !i.call(r, a)) || e(t, r, a);
        return t;
    }
    function n(t) {
    ...
    e(r, {
        ...
        $: function(t, e) {
            return t instanceof Node || t instanceof Window ? [
                t
            ] : 2 != arguments.length || e ? Array.prototype.slice.call("string" == typeof t ? (e || document).querySelectorAll(t) : t || []) : [];
        },
        defined: function() {
        ...
        ready: function(t, e, n) {
            if ("function" != typeof t || e || (e = t, t = void 0), t = t || document, e && ("loading" !== t.readyState ? e() : r.once(t, "DOMContentLoaded", function() {
                e();
            })), !n) return new Promise(function(e) {
                r.ready(t, e, !0);
            });
        },
        Class: function(t) {
            var e, n = [
                ...
                "abstract",
                "static"
            ].concat(Object.keys(r.classProps)), i = t.hasOwnProperty("constructor") ? t.constructor : r.noop;
            2 == arguments.length ? (e = arguments[0], t = arguments[1]) : (e = function() {
                if (this.constructor.__abstract && this.constructor === e) throw new Error("Abstract classes cannot be directly instantiated.");
                e["super"] && e["super"].apply(this, arguments), i.apply(this, arguments);
            }, e["super"] = t["extends"] || null, e.prototype = r.extend(Object.create(e["super"] ? e["super"].prototype : Object), {
                constructor: e
            }), e.prototype["super"] = e["super"] ? e["super"].prototype : null, e.__abstract = !!t["abstract"]);
            var o = function(t) {
                return this.hasOwnProperty(t) && n.indexOf(t) === -1;
            };
            if (t["static"]) {
                r.extend(e, t["static"], o);
                for(var s in r.classProps)s in t["static"] && r.classProps[s](e, t["static"][s]);
            }
        ...
        classProps: {
            ...
            live: t(function(t, e, n) {
                return "function" === r.type(n) && (n = {
                    set: n
                }), Object.defineProperty(t, e, {
                    get: function() {
                        var t = this["_" + e], r = n.get && n.get.call(this, t);
                        return void 0 !== r ? r : t;
                    },
                    set: function(t) {
                        var r = this["_" + e], i = n.set && n.set.call(this, t, r);
        ...
        include: function() {
            var t = arguments[arguments.length - 1], e = 2 === arguments.length && arguments[0], n = document.createElement("script");
            return e ? Promise.resolve() : new Promise(function(e, i) {
                r.set(n, {
                    async: !0,
                    onload: function() {
        ...
        load: function o(t, e) {
            ...
            return n[t + ""] ? n[t + ""] : /\.css$/.test(t.pathname) ? n[t + ""] = new Promise(function(e, n) {
                var i = r.create("link", {
                    href: t,
                    rel: "stylesheet",
                    inside: document.head,
        ...
        fetch: function(t, n) {
            ...
            i.method = i.method.toUpperCase(), r.hooks.run("fetch-args", i), "GET" === i.method && i.data && (i.url.search += i.data), document.body.setAttribute("data-loading", i.url), i.xhr.open(i.method, i.url.href, i.async !== !1, i.user, i.password);
            for(var o in n)if ("upload" === o) i.xhr.upload && "object" == typeof n[o] && r.extend(i.xhr.upload, n[o]);
            else if (o in i.xhr) try {
                i.xhr[o] = n[o];
            } catch (s) {
            ...
            "GET" !== i.method && a.indexOf("content-type") === -1 && i.xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            for(var c in i.headers)void 0 !== i.headers[c] && i.xhr.setRequestHeader(c, i.headers[c]);
            var u = new Promise(function(t, e) {
                i.xhr.onload = function() {
                    document.body.removeAttribute("data-loading"), 0 === i.xhr.status || i.xhr.status >= 200 && i.xhr.status < 300 || 304 === i.xhr.status ? t(i.xhr) : e(r.extend(Error(i.xhr.statusText), {
                        xhr: i.xhr,
                        get status () {
                    ...
                    document.body.removeAttribute("data-loading"), e(r.extend(Error("Network Error"), {
                        xhr: i.xhr
                    }));
                }, i.xhr.ontimeout = function() {
                    document.body.removeAttribute("data-loading"), e(r.extend(Error("Network Timeout"), {
                        xhr: i.xhr
                    }));
        ...
        add: function(t, e, n) {
            if ("string" == typeof arguments[0]) (Array.isArray(t) ? t : [
                t
            ]).forEach(function(t) {
                this[t] = this[t] || [], e && this[t][n ? "unshift" : "push"](e);
            }, this);
            else for(var t in arguments[0])this.add(t, arguments[0][t], arguments[1]);
        },
        run: function(t, e) {
    ...
    r.Element = function(t) {
        ...
        transition: function(t, e) {
            return new Promise((function(n, i) {
                if ("transition" in this.style && 0 !== e) {
                    var o = r.extend({}, this.style, /^transition(Duration|Property)$/);
                    r.style(this, {
        ...
        bind: t(function(t, e) {
            if (arguments.length > 1 && ("function" === r.type(e) || e.handleEvent)) {
                var n = e;
                e = "object" === r.type(arguments[2]) ? arguments[2] : {
                    capture: !!arguments[2]
                }, e.callback = n;
            }
            ...
            t.trim().split(/\s+/).forEach(function(t) {
                ...
                }).length && i[t].push(r.extend({
                    className: n
                }, e)), r.original.addEventListener.call(this, t, e.callback, e);
        ...
        unbind: t(function(t, e) {
            ...
            (t || "").trim().split(/\s+/).forEach(function(t) {
                ...
                if (i) {
                    for(var o in i)if (!t || o === t) for(var s, a = 0; s = i[o][a]; a++)n && n !== s.className || e.callback && e.callback !== s.callback || !!e.capture != !!s.capture && (t || e.callback || void 0 !== e.capture) || (i[o].splice(a, 1), r.original.removeEventListener.call(this, o, s.callback, s.capture), a--);
        ...
        style: function(t) {
            for(var e in t)e in this.style ? this.style[e] = t[e] : this.style.setProperty(e, t[e]);
        },
        ...
        events: function(t) {
            if (1 != arguments.length || !t || !t.addEventListener) return r.bind.apply(this, [
                this
            ].concat(r.$(arguments)));
            var e = this;
            if (r.listeners) {
                var n = r.listeners.get(t);
                for(var i in n)n[i].forEach(function(t) {
        ...
        delegate: t(function(t, e, n) {
            r.bind(this, t, function(t) {
                t.target.closest(e) && n.call(this, t);
            });
        }, 0, 2),
        contents: function(t) {
            (t || 0 === t) && (Array.isArray(t) ? t : [
                t
            ]).forEach(function(t) {
                var e = r.type(t);
                /^(string|number)$/.test(e) ? t = document.createTextNode(t + "") : "object" === e && (t = r.create(t)), t instanceof Node && this.appendChild(t);
            }, this);
        },
        inside: function(t) {
        ...
        n = r.extend({
            ...
            element: !0,
            array: !0
        }, n), "function" == r.type(e) && (!n.element || t in r.Element.prototype && i || (r.Element.prototype[t] = function() {
            ...
            var e = [].slice.apply(arguments), i = e.shift(), o = n.array && Array.isArray(i) ? "Array" : "Element";
            return r[o].prototype[t].apply({
                subject: i
            }, e);
        })));
    }, 0), r.add(r.Array.prototype, {
        element: !1
    }), r.add(r.Element.prototype), r.add(r.setProps), r.add(r.classProps, {
        element: !1,
        array: !1
    });
...
/* jsep v0.3.4 (http://jsep.from.so/) */ !function(e) {
    "use strict";
    var C = "Compound", U = "MemberExpression", w = "Literal", k = function(e, r) {
        ...
        return 36 === e || 95 === e || 65 <= e && e <= 90 || 97 <= e && e <= 122 || 128 <= e && !S[String.fromCharCode(e)];
    }, J = function(e) {
        return 36 === e || 95 === e || 65 <= e && e <= 90 || 97 <= e && e <= 122 || 48 <= e && e <= 57 || 128 <= e && !S[String.fromCharCode(e)];
    }, t = function(n) {
        for(var e, r, p = 0, t = n.charAt, o = n.charCodeAt, i = function(e) {
            return t.call(n, e);
        }, u = function(e) {
            return o.call(n, e);
        }, s = n.length, f = function() {
            for(var e = u(p); 32 === e || 9 === e || 10 === e || 13 === e;)e = u(++p);
        }, c = function() {
            var e, r, t = a();
            return f(), 63 !== u(p) ? t : (p++, (e = c()) || k("Expected expression", p), f(), 58 === u(p) ? (p++, (r = c()) || k("Expected expression", p), {
            ...
            for(var e = n.substr(p, A), r = e.length; 0 < r;){
                if (S.hasOwnProperty(e) && (!q(u(p)) || p + e.length < n.length && !J(u(p + e.length)))) return p += r, e;
                e = e.substr(0, --r);
            }
            return !1;
        }, a = function() {
            ...
            for(o = {
                value: r,
                prec: L(r)
            }, (a = h()) || k("Expected expression after " + r, p), n = [
                i,
                o,
                a
            ]; (r = l()) && 0 !== (t = L(r));){
                for(o = {
                    value: r,
                    prec: t
                }, s = r; 2 < n.length && t <= n[n.length - 2].prec;)a = n.pop(), r = n.pop().value, i = n.pop(), e = B(r, i, a), n.push(e);
                (e = h()) || k("Expected expression after " + s, p), n.push(o, e);
            }
            for(e = n[u = n.length - 1]; 1 < u;)e = B(n[u - 1].value, n[u - 2], e), u -= 2;
            return e;
        }, h = function() {
            var e, r, t;
            ...
            for(t = (r = n.substr(p, j)).length; 0 < t;){
                if (O.hasOwnProperty(r) && (!q(u(p)) || p + r.length < n.length && !J(u(p + r.length)))) return p += t, {
            ...
            if ("e" === (e = i(p)) || "E" === e) {
                for(t += i(p++), "+" !== (e = i(p)) && "-" !== e || (t += i(p++)); M(u(p));)t += i(p++);
                M(u(p - 1)) || k("Expected exponent (" + t + i(p) + ")", p);
            }
            return r = u(p), q(r) ? k("Variable names cannot start with a number (" + t + i(p) + ")", p) : 46 === r && k("Unexpected period", p), {
                type: w,
                value: parseFloat(t),
                raw: t
            };
            ...
            return n || k('Unclosed quote after "' + r + '"', p), {
                type: w,
                value: r,
                raw: t + r + t
            };
            ...
            var e, r = u(p), t = p;
            for(q(r) ? p++ : k("Unexpected " + i(p), p); p < s && (r = u(p), J(r));)p++;
            return e = n.slice(t, p), P.hasOwnProperty(e) ? {
                type: w,
                value: P[e],
                raw: e
            } : "this" === e ? {
            ...
            for(var r, t, n = [], o = !1, i = 0; p < s;){
                if (f(), (r = u(p)) === e) {
                    o = !0, p++, 41 === e && i && i >= n.length && k("Unexpected token " + String.fromCharCode(e), p);
                    break;
                }
                if (44 === r) {
                    if (p++, ++i !== n.length) {
                        if (41 === e) k("Unexpected token ,", p);
                        else if (93 === e) for(var a = n.length; a < i; a++)n.push(null);
                    }
                } else (t = c()) && t.type !== C || k("Expected comma", p), n.push(t);
            }
            return o || k("Expected " + String.fromCharCode(e), p), n;
        }, g = function() {
            var e, r;
            for(r = 40 === (e = u(p)) ? m() : x(), f(), e = u(p); 46 === e || 91 === e || 40 === e;)p++, 46 === e ? (f(), r = {
                type: U,
                computed: !1,
                object: r,
                property: x()
                ...
                object: r,
                property: c()
            }, f(), 93 !== (e = u(p)) && k("Unclosed [", p), p++) : 40 === e && (r = {
                type: "CallExpression",
                arguments: y(41),
                callee: r
            }), f(), e = u(p);
        ...
        }, E = []; p < s;)59 === (e = u(p)) || 44 === e ? p++ : (r = c()) ? E.push(r) : p < s && k('Unexpected "' + i(p) + '"', p);
        return 1 === E.length ? E[0] : {
            type: C,
            body: E
        };
    };
    if (t.version = "0.3.4", t.toString = function() {
    ...
    } else "undefined" != typeof module && module.exports ? exports = module.exports = t : exports.parse = t;
}(this);
...
!function() {
    if (self.Element && (Element.prototype.matches || (Element.prototype.matches = Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || null), Element.prototype.matches)) {
        var p = self.Stretchy = {
            ...
            resize: function(e) {
                if (p.resizes(e)) {
                    var t, i = getComputedStyle(e), n = 0;
                    ...
                    if ("textarea" == o) e.style.height = "0", "border-box" == i.boxSizing ? n = e.offsetHeight : "content-box" == i.boxSizing && (n = -e.clientHeight + parseFloat(i.minHeight)), e.style.height = e.scrollHeight + n + "px";
                        ...
                        if (e.style.width = "1000px", e.offsetWidth) {
                            e.style.width = "0", "border-box" == i.boxSizing ? n = e.offsetWidth : "padding-box" == i.boxSizing ? n = e.clientWidth : "content-box" == i.boxSizing && (n = parseFloat(i.minWidth));
                        ...
                        for(var d in a.textContent = e.options[c].textContent, e.parentNode.insertBefore(a, e.nextSibling), i){
                            var h = i[d];
                            /^(width|webkitLogicalWidth|length)$/.test(d) || "string" != typeof h || (a.style[d] = h, /appearance$/i.test(d) && (s = d));
                        }
        ...
        "loading" !== document.readyState ? requestAnimationFrame(p.init) : document.addEventListener("DOMContentLoaded", p.init), window.addEventListener("load", function() {
            p.resizeAll();
        });
        var e = function(e) {
    ...
    function t(e, t) {
        return e instanceof Node || e instanceof Window ? [
            e
        ] : [].slice.call("string" == typeof e ? (t || document).querySelectorAll(e) : e || []);
    }
}();
...
(async function($, $$1) {
    ...
    var _ = self.Mavo = $.Class({
        constructor: function(element) {
            ...
            $$1(_.selectors.multiple, this.element).forEach((element)=>{
                _.setAttributeShy(element, "property", "");
            });
            // Now, turn properties that contain other properties into groups
            $$1(_.selectors.primitive, this.element).forEach((element)=>{
                if ($(_.selectors.property, element)) {
                    var config = Mavo.Primitive.getConfig(element);
                    if (!config.attribute && !config.hasChildren || Mavo.is("multiple", element)) Mavo.setAttributeShy(element, "typeof", "");
                }
            });
            ...
            this.observe({
                ...
                if (attribute.indexOf("mv-") === 0) {
                    ...
                    if (backendTypes.includes(role)) {
                        ...
                        if (role === "source" || !this.source && (role === "storage" || role === "init" && !this.root.data)) this.load();
                    }
                }
            });
            this.permissions.can("login", ()=>{
                ...
                let loginUrlParam;
                if (Mavo.Functions.url("login") !== null && this.index === 1) loginUrlParam = "login";
                else if (Mavo.Functions.url(this.id + "-login") !== null) loginUrlParam = this.id + "-login";
            ...
            $.bind(this.element, "mv-login.mavo", (evt)=>{
                if (evt.backend == (this.source || this.storage)) // If last time we rendered we got nothing, maybe now we'll have better luck?
                {
                    if (!this.root.data && !this.unsavedChanges) this.load();
                }
            });
            ...
            this.permissions.onchange(({ action , value  })=>{
                ...
                if (value) permissions.push(action);
            ...
            this.observe({
                ...
                if (!this.permissions.edit && !this.permissions.add && !this.permissions.delete) return;
                ...
                nodeloop: for(let i = 0; i < nodes.length; i++){
                    ...
                    node.mode = mode;
                    if (previousMode != node.mode) node[node.mode == "edit" ? "edit" : "done"]();
                }
            });
            if (this.storage || this.source) // Fetch existing data
            this.permissions.can("read", ()=>this.load());
            else // No storage or source
                ...
                if (location.hash) {
                    var callback = ()=>{
                        ...
                        if (target || !location.hash) {
                            if (this.element.contains(target)) requestAnimationFrame(()=>{
                                Mavo.scrollIntoViewIfNeeded(target);
                            });
                        }
                        return target;
                    };
                    if (!callback()) // No target, perhaps not yet?
                    this.observe({
                        attribute: "id",
                        once: true
                    }, callback);
            ...
            if (this.autoSave) this.dataLoaded.then((evt)=>{
                var debouncedSave = _.debounce(()=>{
                    this.save();
                }, this.autoSaveDelay);
                var callback = (evt)=>{
                    if (evt.node.saved && this.autoSave) debouncedSave();
                };
                requestAnimationFrame(()=>{
            ...
            this.element.addEventListener("keydown", (evt)=>{
                ...
                if (this.permissions.save && evt.key == "S" && evt[_.superKey] && !evt.altKey) {
                    ...
                    if (element.matches("textarea, input[type=range], input[type=number]")) // Up/down arrow keys are meaningful here
                    return;
        ...
        error: function(message, ...log) {
            ...
            if (log.length > 0) console.log(`%c${this.id}: ${message}`, "color: red; font-weight: bold", ...log);
        },
        render: function(data) {
            ...
            if (env.data) this.root.render(env.data);
        ...
        edit: function() {
            ...
            $.bind(this.element, "mouseenter.mavo:edit mouseleave.mavo:edit", (evt)=>{
                if (evt.target.matches(_.selectors.multiple)) {
                    ...
                    if (parent) parent.classList.toggle("mv-has-hovered-item", evt.type == "mouseenter");
                }
            }, true);
	 ...
	 */ setUnsavedChanges: function(value) {
            ...
            if (!value) this.walk((obj)=>{
                if (obj.unsavedChanges) {
                    unsavedChanges = true;
                    if (value === false) obj.unsavedChanges = false;
                    return false;
                }
            });
	 ...
	 */ updateBackend (role) {
            ...
            if (this.index == 1) // This app is the first one in the page, so we can override its backend
            // via URL params such as ?storage=...
            backend = _.Functions.url(role);
            if (!backend) backend = _.Functions.url(`${this.id}-${role}`) || this.element.getAttribute(attribute) || null;
            if (backend) {
            ...
            if (backend) {
                ...
                let options = Object.fromEntries(roleAttributes.map((n)=>[
                        n.replace(prefix, ""),
            ...
            } else // We had a backend and now we will un-have it
            this[role] = null;
	 ...
	 */ async load () {
            ...
            let data = await backend.load().catch((err)=>{
                ...
                if (err) {
                    ...
                    if (xhr?.status == 404) this.render(null);
                    else {
                        var message = this._("problem-loading");
                        if (xhr) message += xhr.status ? this._("http-error", err) : ": " + this._("cant-connect");
        ...
        async store () {
            ...
            try {
                ...
                if (err) {
                    ...
                    if (err instanceof XMLHttpRequest) message += ": " + (err.status ? this._("http-error", err) : this._("cant-connect"));
                    this.error(message, err);
                }
                saved = null;
            }
        ...
        upload: function(file, path = "images/" + file.name) {
            if (!this.uploadBackend) return Promise.reject();
        ...
        calculateNeedsEdit: function() {
            var needsEdit = false;
            this.walk((obj, path)=>{
                if (needsEdit) // If already true, no need to descend further
                return false;
        ...
        changed: function(change) {
            if (!this.root) // No tree yet
            return;
            if (this.expressions.active) this.expressions.updateThrottled(change);
        },
        setDeleted: function(...nodes) {
            ...
            if (nodes.length == 1) var phrase = nodes[0].name;
            else {
                var counts = {}, ret = [];
                nodes.forEach((n)=>{
                    counts[n.name] = (counts[n.name] || 0) + 1;
                });
                for(var name in counts)ret.push(this._("n-items", {
                    name,
                    n: counts[name]
                }));
                var phrase = ret.join(", ");
            ...
            notice.closed.then((undone)=>{
                ...
                if (this.deletionNotice == notice) this.deletionNotice = null;
            });
        },
        undoDelete: function() {
        ...
        live: {
            ...
            needsEdit: function(value) {
                if (this.bar) this.bar.toggle("edit", value && this.permissions.edit);
            },
            ...
            primaryBackend: function(value) {
                value = value || null;
                if (value != this._primaryBackend) return value;
            },
            uploadBackend: {
                get: function() {
                    ...
                    if (backend?.upload) {
                        ...
                        if (backend.permissions.login) backend.login();
                        return this.uploads;
                    }
                    if (this.storage?.upload) // Prioritize storage
                    return this.storage;
                }
            }
        },
        static: {
            ...
            init: function(container = document) {
                var mavos = Array.isArray(arguments[0]) ? arguments[0] : $$1(_.selectors.init, container);
            ...
            warn: function warn(message, o = {}) {
                ...
                if (!_.warn.history.has(message)) console.warn(message);
                if (o.once !== false) warn.history.add(message);
            },
            /**
		 ...
		 */ thenAll: function(iterable) {
                ...
                $$1(iterable).forEach((promise)=>{
                    if ($.type(promise) == "promise") promise = promise.catch((err)=>err);
                });
                return Promise.all(iterable).then((resolved)=>{
                    if (iterable.length != resolved.length) // The list of promises or values changed. Return a new Promise.
            ...
            promise: function(constructor) {
                ...
                var promise = new Promise((resolve, reject)=>{
                    if (typeof constructor === "function") constructor(resolve, reject);
    ...
    });
    {
        let s = _.selectors = {
            ...
            textInput: [
                ...
                "search",
                "number"
            ].map((t)=>`input[type=${t}]`).join(", ") + ", input:not([type]), textarea",
            ui: ".mv-ui",
            container: {
                // "li": "ul, ol",
                "tr": "table",
    ...
    $.each(_.polyfillsNeeded, (id, supported)=>{
        if (!supported) _.polyfills.push(id);
    });
    ...
    $$1(_.selectors.init).forEach(function(elem) {
        // Skip if an instance has been created, for example by another script.
        if (!_.get(elem)) elem.setAttribute("mv-progress", "Loading");
    });
    await _.ready;
    _.init();
    _.inited.resolve();
...
(function($, $$1) {
	 ...
	 */ load: (url, base = document.currentScript?.src ?? location)=>{
        ...
        toJSON: (data)=>{
            if (data === null) return "";
            if (typeof data === "string") // Do not stringify twice!
            return data;
            try {
	 ...
	 */ safeToJSON: function(o) {
            ...
            return JSON.stringify(o, (key, value)=>{
                if (typeof value === "object" && value !== null) {
                    ...
                    if (cache.has(value)) return; // Circular reference found!
                    cache.add(value);
                }
                return value;
            });
	 ...
	 */ // If the passed value is not an array, convert to an array
        toArray: (arr)=>{
            return arr === undefined ? [] : Array.isArray(arr) ? arr : [
                arr
            ];
        },
        ...
        filter: (arr, callback)=>{
            for(var i = 0; i < arr.length; i++)if (!callback(arr[i])) {
                arr.splice(i, 1);
                i--;
            }
        },
	 ...
	 */ is: function(thing, ...elements) {
            for(let i = 0, element; i < elements.length; i++){
                if (elements?.[i]?.matches?.(_.selectors[thing])) return true;
            }
            return false;
        },
        /**
	 ...
	 */ data: function(element, name, value) {
            ...
            if (arguments.length == 2) ret = data[name];
            else if (value === undefined) delete data[name];
            else ret = data[name] = value;
	 ...
	 */ elementPath: function(ancestor, element) {
            if (Array.isArray(element)) {
                ...
                for(var parent = element; parent && parent != ancestor; parent = parent.parentNode){
                    ...
                    var sibling = parent;
                    while(sibling = sibling[`previous${countNonElementSiblings ? "" : "Element"}Sibling`])if (countNonElementSiblings) {
                        offset++;
                        if (sibling.nodeType == 1) countNonElementSiblings = false;
                    } else index++;
                    if (offset > 0) index = index - 1 + "." + offset;
                    path.unshift(index);
                }
	 ...
	 */ revocably: {
            add: function(element, insert) {
                ...
                if (comment?.parentNode) comment.parentNode.replaceChild(element, comment);
                else if (element && insert && !element.parentNode) {
                    // Has not been revocably removed because it has never even been added
                    if (typeof insert === "function") insert(element);
                    else insert.appendChild(element);
                }
                return comment;
            },
            remove: function(element, commentText) {
                ...
                if (element.parentNode) // In DOM, remove
            ...
            isRemoved: function(element) {
                ...
                var comment = _.data(element, "commentstub");
                if (comment?.parentNode) return comment;
                return false;
            },
            setAttribute: function(element, attribute, value) {
                var previousValue = _.data(element, "attribute-" + attribute);
                if (previousValue === undefined) // Only set this when there's no old value stored, otherwise
        ...
        scrollIntoViewIfNeeded: (element)=>{
            if (element && !Mavo.inView.is(element)) element.scrollIntoView({
                behavior: "smooth"
            });
        },
        /**
	 ...
	 */ getTarget: function() {
        ...
        XPath: function(query, context = document) {
            ...
            if (doc.evaluate) {
                ...
                while(node = result.iterateNext())ret.push(node);
            }
            return ret;
        },
	 ...
	 */ in: function(property, obj) {
            if (obj) return typeof obj === "object" && property in obj || obj[property] !== undefined;
        },
        /**
	 ...
	 */ getCanonicalProperty: function(obj, property) {
        ...
        subset: function(obj, path, value) {
            if (arguments.length == 3) {
                ...
                if (path.length) {
                    ...
                    if (Array.isArray(parent) && Array.isArray(value)) // Merge arrays instead of adding array inside array
                    parent.splice(last, 1, ...value);
                    else if (parent) parent[path[path.length - 1]] = value;
                    return obj;
                }
                return value;
            } else if (typeof obj == "object" && path?.length) return path.reduce((obj, property, i)=>{
                var meta = {};
                ...
                if (ret === undefined && meta.query) // Not found, return dummy if query
                ret = {
        ...
        observeResize: function(element, callbackOrObserver) {
            ...
            var ro = callbackOrObserver instanceof ResizeObserver ? callbackOrObserver : new ResizeObserver((entries)=>{
                ...
                if (previousRect && previousRect.width == contentRect.width && previousRect.height == contentRect.height) return;
        ...
        Observer: class Observer {
            constructor(element, attribute, callback, o = {}){
                if (callback instanceof MutationObserver) this.observer = callback;
            ...
            update(element, attribute, options) {
                ...
                if (options === undefined || !options.attributes && !options.childList && !options.characterData) {
                    if (this.attribute) Object.assign(this.options, {
                        attributes: true,
                        attributeFilter: this.attribute == "all" ? undefined : Mavo.toArray(this.attribute),
                        attributeOldValue: !!options.oldValue
                    });
                    if (!this.attribute || this.attribute == "all") Object.assign(this.options, {
                        characterData: true,
                        childList: true,
                        subtree: true,
            ...
            flush() {
                ...
                if (records) this.callback(records);
            }
            stop() {
		 ...
		 */ resume() {
                if (this.runOnResume !== false) this.run();
	 ...
	 */ options: (str)=>{
            ...
            str.trim().match(/(?:\\[,;]|[^,;])+/g)?.forEach((option)=>{
                if (option) {
                    ...
                    if (pair) ret[pair[1].replace(/\\:/g, ":")] = pair[2];
                    else // If no value, it's boolean
                    ret[option] = true;
                }
            });
            return ret;
	 ...
	 */ BucketMap: class BucketMap {
            ...
            delete(key, value) {
                if (arguments.length == 2) {
                    var values = this.map.get(key);
                    if (values) {
                        if (this.arrays) _.delete(values, value);
 ...
 */ _.Observers = class Observers extends Map {
        constructor({ observer , callback  } = {}){
            super();
            let self1 = _.Observers;
            this.callback = callback || self1.callback;
            this.observer = observer || (self1.observer = self1.observer || new MutationObserver(this.callback));
        }
        applyRecord(r) {
            for (let [o, callback] of this.entries())if (_.Observers.matchesRecord(o, r)) {
                ...
                if (o.once) this.unobserve(o, callback);
            }
        }
        static matchesRecord(o, r) {
            if (o.active === false) return false;
            let element = r.target;
            if (o.selector && !element.matches?.(o.selector)) return false;
            if (o.attribute) {
                // We are monitoring attribute changes only
                if (r.type !== "attributes") // Not an attribute change
                return false;
                if (o.attribute !== true && o.attribute !== r.attributeName && !o.attribute.includes?.(r.attributeName)) // We are monitoring specific attribute(s), and a different one changed
                return false;
            } else if (r.type === "attributes" && o.attribute === false) // We explicitly opted out monitoring attributes, and an attribute has changed
            return false;
            if (o.element) {
                if (o.deep === false) return element === o.element;
                else return o.element.contains(element);
            }
            return true;
        }
        flush() {
        ...
        resume(matches) {
            if (!(matches instanceof _.Observers)) matches = this.find(matches);
            this.flush();
            for (let [o, c] of matches.entries()){
        ...
        find(options, callback) {
            ...
            for (let [o, c] of this.entries()){
                if (callback && callback !== c) continue;
                if (keys.every((k)=>o[k] === options[k])) ret.set(o, c);
            }
            return ret;
        }
    };
    ...
    _.Observers.callback = (records)=>{
        ...
        for (let r of records)_.observers.applyRecord(r);
    };
    // Bliss plugins
    ...
    function updateTargetWithin() {
        ...
        $$1("." + cl).forEach((el)=>el.classList.remove(cl));
...
(function($, $$1) {
    var _ = Mavo.Locale = $.Class({
        ...
        get fallback () {
            ...
            if (_.all[this.baseLang]) return _.all[this.baseLang];
            if (this !== _.default) return _.default;
        },
        ...
        phrase: function(id, vars) {
            ...
            if (phrase === undefined && this.fallback) phrase = this.fallback.phrase(key);
            if (phrase === undefined) // Everything failed, use id
            phrase = key.replace(/\b-\b/g, " ");
            else if (vars) {
                var keys = phrase.match(/\{\w+(?=\})/g)?.map((v)=>v.slice(1)) ?? [];
                Mavo.Functions.unique(keys).forEach((name)=>{
                    if (name in vars) phrase = phrase.replace(RegExp(`{${name}}`, "gi"), vars[name]);
                });
            }
            return phrase;
        },
        live: {
            lang: function(lang) {
                ...
                if (lang == this.baseLang) this.baseLang = null;
            }
        },
        static: {
            all: {},
		 ...
		 */ register: function(lang, phrases) {
                if (_.all[lang]) _.all[lang].extend(phrases);
                else _.all[lang] = new _(lang, phrases);
            },
 ...
 */ Mavo.prototype._ = function(id, vars) {
    ...
    Mavo.ready.then(()=>{
        $$1("datalist.mv-phrases[lang]").forEach((datalist)=>{
            var phrases = $$1("option", datalist).reduce((o, option)=>{
    ...
    var _ = Mavo.Plugins = {
        ...
        async load () {
            ...
            return Mavo.thenAll(plugin.filter((plugin)=>_.plugins.has(plugin.id)).map((plugin)=>{
                ...
                if (plugin.repo) // Plugin hosted in a separate repo
                var url = `https://cdn.jsdelivr.net/gh/${plugin.repo}@master/${filename}`;
                else // Plugin hosted in the mavo-plugins repo
                var url = `${_.url}/${plugin.id}/${filename}`;
                return $.include(_.loaded[plugin.id], url);
            }));
        },
        register: function(name, o = {}) {
            if (_.loaded[name]) // Do not register same plugin twice
            return;
            Mavo.hooks.add(o.hooks);
            for(let Class in o.extend){
                let existing = Class == "Mavo" ? Mavo : Mavo[Class];
                if ($.type(existing) === "function") $.Class(existing, o.extend[Class]);
                else $.extend(existing, o.extend[Class]);
            }
            var ready = [];
            if (o.ready) ready.push(o.ready);
            if (o.dependencies) {
            ...
            if (ready.length) Mavo.dependencies.push(...ready);
            _.loaded[name] = o;
            if (o.init) Promise.all(ready).then(()=>o.init());
        },
...
(function($, $$1) {
    ...
    var _ = Mavo.UI.Bar = $.Class({
        constructor: function(mavo) {
            ...
            } else this.element = $.create({
                className: "mv-bar mv-ui",
                start: this.mavo.element,
                innerHTML: "<button>&nbsp;</button>"
            });
            if (this.element.classList.contains("mv-compact")) this.noResize = true;
            this.controls = _.getControls(this.template);
            if (this.controls.length) // Measure height of 1 row
            this.targetHeight = this.element.offsetHeight;
            if (!this.custom) this.element.innerHTML = "";
            this.controls.forEach((id)=>{
                let o = _.controls[id];
                if (this[id]) // Custom control, remove to not mess up order
                this[id].remove();
                if (o.create) this[id] = o.create.call(this.mavo, this[id]);
                else if (!this[id]) this[id] = $.create("button", {
                    type: "button",
                    className: `mv-${id}`,
                ...
                this.add(id);
                if (o.permission) this.permissions.can(o.permission, ()=>{
                    this.toggle(id, !o.condition || o.condition.call(this.mavo));
                }, ()=>{
                    this.remove(id);
                });
                else if (o.condition && !o.condition.call(this.mavo)) this.remove(id);
                for(var events in o.events)$.bind(this[id], events, o.events[events].bind(this.mavo));
            });
            for(let id in _.controls){
                let o = _.controls[id];
                if (o.action) $.delegate(this.mavo.element, "click", ".mv-" + id, (evt)=>{
            ...
            if (this.controls.length && !this.noResize) {
                this.resize();
                if (self.ResizeObserver) this.resizeObserver = Mavo.observeResize(this.element, (entries)=>{
                    this.resize();
                });
            }
        },
        resize: function() {
            ...
            $$1("button, .mv-button", this.element).forEach((button)=>{
                if (button.title === button.textContent) button.title = "";
            });
            // Exceeded single row?
            if (this.element.offsetHeight > this.targetHeight * 1.6) {
                ...
                if (this.element.offsetHeight > this.targetHeight * 1.2) {
                    ...
                    $$1("button, .mv-button", this.element).forEach((button)=>{
                        if (!button.title) button.title = button.textContent;
                    });
                }
            }
        ...
        add: function(id) {
            var o = _.controls[id];
            if (o.prepare) o.prepare.call(this.mavo);
            Mavo.revocably.add(this[id], this.element);
            if (!this.resizeObserver && !this.noResize) requestAnimationFrame(()=>this.resize());
        },
        remove: function(id) {
            var o = _.controls[id];
            Mavo.revocably.remove(this[id], "mv-" + id);
            if (o.cleanup) o.cleanup.call(this.mavo);
            if (!this.resizeObserver && !this.noResize) requestAnimationFrame(()=>this.resize());
        },
        ...
        static: {
            getControls: function(template) {
                ...
                if (template && (template = template.trim())) {
                    ...
                    if (relative) return all.filter((id)=>{
            ...
            controls: {
                status: {
                    ...
                    prepare: function() {
                        ...
                        if (backend?.user) {
                            ...
                            if (user.avatar) html.unshift($.create("img", {
                                className: "mv-avatar",
                                src: user.avatar
                            }), " ");
                            if (user.url) html = [
                ...
                edit: {
                    ...
                    cleanup: function() {
                        if (this.editing) {
                            this.done();
                            if (this.bar?.edit) this.bar.edit.textContent = this._("edit");
                        }
                    },
                    condition: function() {
                ...
                export: {
                    create: function(custom) {
                        var a;
                        if (custom) a = custom.matches("a") ? custom : $.create("a", {
                            className: "mv-button",
                            around: custom
                        });
                        else a = $.create("a", {
...
(function($, $$1) {
    var _ = Mavo.UI.Message = $.Class({
        constructor: function(mavo, message, o = {}) {
            ...
            if (o.style) $.style(this.element, o.style);
            if (o.classes) this.element.classList.add(...o.classes.split(/\s+/));
            if (o.type == "error") this.element.setAttribute("role", "alert");
            else this.element.setAttribute("aria-live", "polite");
            o.dismiss = o.dismiss || {};
            ...
            if (o.dismiss.button) $.create("button", {
                type: "button",
            ...
            if (o.dismiss.submit) this.element.addEventListener("submit", (evt)=>{
                evt.preventDefault();
...
(function($, $$1) {
    var _ = Mavo.Permissions = $.Class({
        ...
        can: function(actions, callback, cannot) {
            ...
            if (cannot) // Fired once the action cannot be done anymore, even though it could be done before
        ...
        observe: function(actions, value, callback) {
            ...
            if (this.is(actions, value)) // Should be fired immediately
            callback();
        ...
        parentChanged: function(o = {}) {
            ...
            if (localValue !== undefined || o.from == o.value) // We have a local value so we don’t care about parent changes OR nothing changed
            return;
        ...
        fireTriggers: function(action) {
            this.triggers.forEach((trigger)=>{
                ...
                if (trigger.active && trigger.actions.indexOf(action) > -1 && match) {
                    ...
                    trigger.callback();
                } else if (!match) // This is so that triggers can only be executed in an actual transition
        ...
        live: {
            parent: function(parent) {
                ...
                if (oldParent) Mavo.delete(oldParent.hooks.change, this.parentChanged);
            ...
            register: function(action, setter) {
                ...
                $.live(_.prototype, action, {
                    get: function() {
                        ...
                        if (ret === undefined && this.parent) return this.parent[action];
                        return ret;
                    },
                    set: function(able, previous) {
                        if (setter) setter.call(this, able, previous);
    ...
    _.register("login", function(can) {
        if (can && this.logout) this.logout = false;
    });
    _.register("logout", function(can) {
        if (can && this.login) this.login = false;
    });
    _.register("edit", function(can) {
        if (can) this.add = this.delete = true;
    });
    _.register([
        "add",
        "delete"
    ], function(can) {
        if (!can) this.edit = false;
    });
})(Bliss, Bliss.$);
(function($, $$1) {
    /**
 ...
 */ var _ = Mavo.Backend = $.Class({
        ...
        update: function(url, o = {}) {
            ...
            if (this.constructor.key ?? o.key) this.key = o.key ?? this.constructor.key;
        },
        async get (url = new URL(this.url)) {
            if (url.protocol != "data:" && this.constructor.useCache !== false) url.searchParams.set("timestamp", Date.now()); // ensure fresh copy
            try {
        ...
        async load () {
            ...
            if (typeof response != "string") // Backend did the parsing, we're done here
            return response;
	 ...
	 */ request: function(call, data, method = "GET", req = {}) {
            ...
            if (this.isAuthenticated()) req.headers["Authorization"] = req.headers["Authorization"] || `Bearer ${this.accessToken}`;
            req.data = data;
            ...
            if (req.method == "GET" && this.constructor.useCache !== false) call.searchParams.set("timestamp", Date.now());
            if ($.type(req.data) === "object") {
                if (req.method == "GET") {
                    ...
                    delete req.data;
                } else req.data = JSON.stringify(req.data);
            }
            return $.fetch(call, req).catch((err)=>{
                if (err?.xhr) return Promise.reject(err.xhr);
                else this.mavo.error("Something went wrong while connecting to " + this.id, err);
            ...
            return this.ready.then(()=>{
                ...
                return new Promise((resolve, reject)=>{
                    ...
                    if (passive) {
                        ...
                        this.authPopup = open(`${this.constructor.oAuth}?client_id=${this.key}&state=${encodeURIComponent(JSON.stringify(state))}` + this.oAuthParams(), "popup", `width=${popup.width},height=${popup.height},left=${popup.left},top=${popup.top}`);
                        if (!this.authPopup) {
                        ...
                        addEventListener("message", (evt)=>{
                            if (evt.source === this.authPopup) {
                                if (evt.data.backend == this.id) this.accessToken = localStorage[`mavo:${id}token`] = evt.data.token;
                                if (!this.accessToken) reject(Error("Authentication error"));
                                ...
                                for(var appid in Mavo.all){
                                    ...
                                    if (storage && storage.id === this.id && storage !== this && !storage.isAuthenticated()) storage.login(true);
                                }
                            }
                        });
                    }
	 ...
	 */ oAuthLogout: function() {
        ...
        static: {
            ...
            create: function(url, o = {}, existing) {
                let Backend;
                if (o.type) // Using get() for case-insensitive property lookup
                Backend = Mavo.Functions.get(_, o.type);
                if (url && !Backend) Backend = _.types.find((Backend)=>Backend.test(url, o)) || _.Remote;
 ...
 */ _.register($.Class({
    ...
    _.register($.Class({
        ...
        put: function(serialized) {
            if (!serialized) delete localStorage[this.key];
            else localStorage[this.key] = serialized;
    ...
    var csv = _.CSV = $.Class({
        ...
        static: {
            ...
            parse: async (serialized, me)=>{
                ...
                if (data.meta.aborted) throw data.meta.errors.pop();
                return {
                    [property]: data.data
                };
            },
    ...
    Object.defineProperty(_, "create", {
        value: function(format, backend) {
            ...
            if (!format) {
                ...
                var Format = _.JSON;
                for(var id in _)if (_[id].extensions.indexOf(extension) > -1) // Do not return match, as we may find another match later
                // and last match wins
                Format = _[id];
...
(function($, $$1) {
    var _ = Mavo.Node = class Node1 {
        constructor(element, mavo, options = {}){
            if (!element || !mavo) throw new Error("Mavo.Node constructor requires an element argument and a mavo object");
            var env = {
                context: this,
                options
            };
            ...
            if (this.template) this.template.copies.push(this);
            else // First (or only) of its kind
            this.copies = [];
            ...
            if (this.collection) // This is a collection item
            this.group = this.parentGroup = this.collection.parentGroup;
            // Must run before collections have a marker which messes up paths
            var template = this.template;
            if (template?.expressions) // We know which expressions we have, don't traverse again
	 ...
	 */ postInit() {
            if (this.modes == "edit") this.edit();
        }
        destroy() {
            if (this.template) Mavo.delete(this.template.copies, this);
            if (this.expressions) this.expressions.forEach((expression)=>expression.destroy());
            if (this.itembar) this.itembar.destroy();
	 ...
	 */ walk(callback, path = [], o = {}) {
            var walker = (obj, path)=>{
                ...
                if (ret !== false) for(let i in obj.children){
                    let node = obj.children[i];
                    if (node instanceof Mavo.Node) {
                        var ret = walker.call(node, node, [
                            ...path,
                            i
                        ]);
                        if (ret === false && !o.descentReturn) return false;
                    }
                }
                return ret !== false;
            };
        ...
        edit({ force  } = {}) {
            this.mode = "edit";
            if (!force && this.mode != "edit") return false;
            ...
            if (!force && this.mode != "read") return false;
            $.unbind(this.element, ".mavo:edit");
        ...
        propagate(callback) {
            for(let i in this.children){
                ...
                if (node instanceof Mavo.Node) {
                    if (typeof callback === "function") callback.call(node, node);
                    else if (callback in node) node[callback]();
                }
            }
        }
        fromTemplate(...properties) {
            if (this.template) properties.forEach((property)=>this[property] = this.template[property]);
        ...
        async render(data, o = {}) {
            ...
            if ($.type(data) === "promise") {
                ...
                if (this.pending !== pending) // Value has been superseded
                return;
                delete this.pending;
            }
            if (o.live) // Drop proxy
            data = Mavo.clone(data);
            this.oldData = this.data;
            this.data = data;
            if (!o.live) data = Mavo.subset(data, this.inPath);
            var env = {
                context: this,
                data,
                options: o
            ...
            if (!this.isHelperVariable) {
                ...
                } else if (this.childrenNames?.length == 1 && this.childrenNames[0] === this.property && env.data !== null && Mavo.isPlainObject(env.data)) // {foo: {foo: 5}} should become {foo: 5}
                env.data = env.data[this.property];
            }
            if (this === o.root) this.expressionsEnabled = false;
            var editing = this.editing;
            if (editing) this.done();
            var changed = this.dataRender(env.data, o);
            if (editing) this.edit();
            if (this === o.root) {
                this.save();
                this.expressionsEnabled = true;
                if (changed) requestAnimationFrame(()=>this.mavo.expressions.update(this));
            }
        ...
        getClosestCollection() {
            var closestItem1 = this.closestItem;
            return closestItem1 ? closestItem1.collection : null;
        }
        getClosestItem() {
            if (Array.isArray(this.collection?.children)) return this;
	 ...
	 */ getCousin(offset, o = {}) {
            ...
            if (o.wrap) index = Mavo.wrap(index, collection.length);
            for(var i = 0; i < collection.length; i++){
                var ind = index + i * direction;
                if (o.wrap) ind = Mavo.wrap(ind, collection.length);
        ...
        static create(element, mavo, o = {}) {
            if (Mavo.is("multiple", element) && !o.collection) return new Mavo.Collection(element, mavo, o);
	 ...
	 */ static getProperty(element) {
            ...
            if (!property) {
                ...
                if (element.hasAttribute("property")) {
                    ...
                    if (!property) property = _.generatePropertyName(multiple === null ? "prop" : "collection", element);
                }
            }
        ...
        static generatePropertyName(prefix, element = document.documentElement) {
            ...
            for(var i = ""; i < 10000; i++){
                var name = prefix + i;
                if (!$(Mavo.selectors.specificProperty(name), root)) return name;
            }
        }
        static get(element, prioritizePrimitive) {
            var nodes = (_.elements.get(element) || []).filter((node)=>!Array.isArray(node.children));
            if (nodes.length < 2 || !prioritizePrimitive) return nodes[0];
            if (nodes[0] instanceof Mavo.Group) return nodes[1];
        }
        static getClosest(element, prioritizePrimitive) {
            var node;
            do node = _.get(element, prioritizePrimitive);
            while (!node && (element = element.parentNode));
            return node;
        }
        static getClosestItem(element) {
            var item = _.getClosest(element);
            if (item instanceof Mavo.Primitive && !item.collection) return item.parent;
            return item;
        }
        /**
	 ...
	 */ static children(element) {
            ...
            if (ret) // element is a Mavo node
            return [
                ret
            ];
            ret = $$1(Mavo.selectors.property, element).map((e)=>Mavo.Node.get(e)).filter((e)=>!element.contains(e.parentGroup.element)) // drop nested properties
    ...
    $.Class(_, {
        ...
        live: {
            ...
            unsavedChanges: function(value) {
                if (value && (!this.saved || !this.editing)) value = false;
                if (!Array.isArray(this.children)) this.element.classList.toggle("mv-unsaved-changes", value);
                return value;
            },
            mode: function(value) {
                if (this._mode != value) {
                    // Is it allowed?
                    if (this.modes && value != this.modes) value = this.modes;
                    ...
                    if (!Array.isArray(this.children) && [
                        ...
                        "read",
                        "edit"
                    ].indexOf(this.element.getAttribute("mv-mode")) > -1) {
            ...
            modes: function(value) {
                if (value && value != "read" && value != "edit") return null;
                this._modes = value;
                if (value && this.mode != value) this.mode = value;
            },
            ...
            expressionsEnabled: {
                get: function() {
                    if (this._expressionsEnabled === false) return false;
                    else return this.parent ? this.parent.expressionsEnabled : true;
                }
            }
        },
        static: {
    ...
    Mavo.observe({
        ...
        if (node) node.storage = node.element.getAttribute("mv-storage");
    });
})(Bliss, Bliss.$);
(function($, $$1) {
    var _ = Mavo.Group = class Group extends Mavo.Node {
        constructor(element, mavo, o){
            ...
            if (Mavo.Primitive.getValueAttribute(this.element)) this.children[this.property] = new Mavo.Primitive(this.element, this.mavo, {
                group: this
            });
            ...
            var properties = $$1(Mavo.selectors.property + ", " + Mavo.selectors.multiple, this.element).filter((element)=>{
            ...
            properties.forEach((element)=>{
                ...
                if (collections[property] !== "multiple") collections[property] = Mavo.is("multiple", element) ? "multiple" : (collections[property] || 0) + 1;
            });
            ...
            properties.forEach((element, i)=>{
                ...
                if (isCollection === "multiple") {
                    ...
                    if (existing instanceof Mavo.Collection) existing.add(element);
                    ...
                    } else this.children[property] = [
                        ...existing || [],
                        element
                    ];
                } else if (isCollection > 1) {
                    if (!this.children[property]) this.children[property] = new Mavo.ImplicitCollection(element, this.mavo, options);
                    else this.children[property].add(element);
                } else // Normal case
        ...
        getData(o = {}) {
            ...
            for(var property in this.children){
                ...
                if (obj.saved && Mavo.value(data) !== null) env.data[obj.property] = data;
                else delete env.data[obj.property];
            }
            if (!this.childrenNames.length && !this.isRoot && !this.collection) // Avoid {} in the data
            env.data = null;
            else if (this.childrenNames.length === 1 && this.property in this.children) env.data = env.data[this.property];
            else if (env.data && typeof env.data === "object") {
                // Add JSON-LD stuff
                if (this.type && this.type != _.DEFAULT_TYPE) env.data["@type"] = this.type;
                if (this.vocab) env.data["@context"] = this.vocab;
            }
        ...
        edit(o = {}) {
            if (super.edit() === false) return false;
        ...
        dataRender(data, o = {}) {
            ...
            if (copy) this.propagate((obj)=>{
                if (obj.currentAlias) {
                    data[obj.property] = copy[obj.currentAlias];
                    if (!(obj.currentAlias in this.children)) delete data[obj.currentAlias];
                }
            });
            if (!wasPrimitive || noWriteableProperty) {
                ...
                for(let property in data)if (!(property in this.children)) {
                    let value = data[property];
                    changed = changed || data[property] !== this.liveData.data[property];
                    this.liveData.set(property, value);
                    if (typeof value != "object" && (!oldData || oldData[property] != value)) // Property actually changed. Why != "object" though?
...
(async function($, $$1) {
    var _ = Mavo.Primitive = class Primitive extends Mavo.Node {
        constructor(element, mavo, o){
            ...
            if (!this.fromTemplate("config", "attribute", "templateValue", "originalEditor")) {
                ...
                if (this.attribute && !document.xmlVersion) this.attribute = this.attribute.toLowerCase();
            }
            ...
            /**
		 * Set up input widget
		 */ if (this.config.init) this.config.init.call(this, this.element);
            ...
            if (this.config.changeEvents) $.bind(this.element, this.config.changeEvents, (evt)=>{
                if (evt.target === this.element) this.value = this.getValue();
            });
            if (this.expressionText) this.setValue(this.expressionText.value, {
                silent: true
            });
            else {
                if (this.element.hasAttribute("aria-label")) // Custom label
                ...
                if (this.element.hasAttribute("mv-editor")) {
                    ...
                    if (!this.datatype && (typeof editorValue == "number" || typeof editorValue == "boolean")) this.datatype = typeof editorValue;
                }
                ...
                if (this.default === null) {
                    ...
                    if (this.defaultExpression) // To preserve type, e.g. booleans should stay booleans, not become strings
                ...
                if (this.default === undefined && keepTemplateValue) this.initialValue = this.templateValue;
                else this.initialValue = this.default;
                if (this.initialValue === undefined) this.initialValue = this.emptyValue;
        ...
        get editorValue() {
            ...
            if (editor) {
                if (editor.matches(Mavo.selectors.formControl)) return _.getValue(editor, {
        ...
        set editorValue(value) {
            if (this.config.setEditorValue && this.datatype !== "boolean") return this.config.setEditorValue.call(this, value);
            if (this.editor) {
                if (this.editor.matches(Mavo.selectors.formControl)) {
                    if (this.editor.matches("select")) {
                        let text = [
                            ...this.editor.options
                        ].find((o)=>o.value == value)?.textContent;
                        // We have a local editor, do we need to add/remove temp options?
                        if (text === undefined) // Option not found in the select menu, add a temp option
                        $.create("option", {
                    ...
                    if (output) _.setValue(output, value);
                }
            }
        }
        destroy() {
        ...
        getData(o = {}) {
            ...
            if (this.isDataNull(o)) return null;
            env.data = this.value;
            if (env.data === "" && (!this.templateValue || this.initialValue !== this.templateValue)) env.data = null;
            if (this.inPath.length) env.data = Mavo.subset(this.data, this.inPath, env.data);
            Mavo.hooks.run("node-getdata-end", env);
            return env.data;
        }
        ...
        initEdit() {
            if (!this.editor && this.originalEditor) this.editor = this.originalEditor.cloneNode(true);
            this.editorUpdated();
            this.initEdit = null;
        }
        generateDefaultEditor() {
            ...
            if (!editor || this.datatype == "boolean") editor = Mavo.Elements.defaultConfig[this.datatype || "string"].editor;
            this.editor = $.create($.type(editor) === "function" ? editor.call(this) : editor);
            this.editorValue = this.value;
        }
        updateEditType() {
            let ret = this.element.getAttribute("mv-edit-type")?.trim() ?? "auto";
            if (ret === "auto") // attribute may be "auto", in which case we want to get in here
            ret = this.config.editType ?? "auto";
            if (ret === "auto") ret = this.attribute ? "popup" : "inline";
            return this.editType = ret;
        }
        editorUpdated() {
            if (!this.editor) this.generateDefaultEditor();
            $.bind(this.editor, {
                "input change": (evt)=>{
            ...
            if (!multiline) this.editor.addEventListener("focus", (evt)=>{
                this.editor.select?.();
            });
            if ("placeholder" in this.editor && !this.editor.placeholder) this.editor.placeholder = `(${this.label})`;
        ...
        originalEditorUpdated() {
            ...
            if (previousOriginalEditor === this.originalEditor) return;
                ...
                if (!this.template || this.originalEditor !== this.template.originalEditor) {
                    ...
                    this.originalEditorObserver = new Mavo.Observer(this.originalEditor, "all", (records)=>{
                        ...
                        for (let primitive of nodes){
                            if (primitive.defaultSource == "editor") primitive.default = this.originalEditor.value;
                            if (primitive.editor) primitive.editor = this.originalEditor.cloneNode(true);
        ...
        edit(o = {}) {
            ...
            if (super.edit(o) === false) // Invalid edit
            return false;
            if (!o.force && wasEditing && !this.initEdit) // Already being edited
            return true;
            if ($.type(this._value) === "object") // Editing is disabled when value is an object (see #692)
            return false;
            if (!wasEditing) {
                // Make element focusable, so it can actually receive focus
                if (this.element.tabIndex === -1) Mavo.revocably.setAttribute(this.element, "tabindex", "0");
                // Prevent default actions while editing
                // e.g. following links etc
                if (!this.modes) $.bind(this.element, "click.mavo:edit", (evt)=>{
                    if (!this.editor.contains(evt.target)) evt.preventDefault();
                });
            }
            if (this.closestCollection && this.editor && this.editor.matches(Mavo.selectors.textInput)) {
                ...
                let multiline = this.editor.matches("textarea");
                if (!multiline) $.bind(this.editor, "paste.mavo:edit", (evt)=>{
                    if (!this.closestCollection.editing || !evt.clipboardData) return;
                    ...
                    if (CRLF.test(text)) {
                        ...
                        for(let i = 1; i < lines.length; i++){
                            let closestItem1 = this.closestItem;
                ...
                $.bind(this.editor, "keydown.mavo:edit", (evt)=>{
                    if (!this.closestCollection.editing) return;
                    if (evt.key == "Enter" && (evt.shiftKey || !multiline)) {
                        if (this.bottomUp) return;
                        let closestItem1 = this.closestItem;
                        let next = this.closestCollection.add(undefined, closestItem1?.index + 1);
                        ...
                        if (multiline) evt.preventDefault();
            ...
            if (this.editType === "popup") {
                ...
                if (!this.editor.isConnected) {
                    this.editorValue = this.value;
                    if (this.config.hasChildren) this.element.textContent = "";
                    else _.setText(this.element, "");
                    ...
                    if (!this.contentExpression) this.contentExpression = Mavo.DOMExpression.search(this.element, null);
                    if (this.contentExpression) this.contentExpression.active = false;
                    this.element.prepend(this.editor);
                }
                if (!this.collection) Mavo.revocably.restoreAttribute(this.element, "tabindex");
            }
            this.resumeObserver();
            return true;
        }
        done(o) {
            if (super.done(o) === false) return false;
            $.unbind(this.element, ".mavo:edit");
            this.pauseObserver();
            if (this.config.done) {
            ...
            if (this.editType === "popup") this.popup?.close();
            ...
            if (this.editor?.matches("select")) // Remove any temp options that we don’t need anymore
            $$1(".mv-volatile", this.editor).forEach((o)=>{
        ...
        dataRender(data, { live , root  } = {}) {
            ...
            if ($.type(data) === "object") {
                if (Symbol.toPrimitive in data) data = data[Symbol.toPrimitive]("default");
                else // Disable editing when the value is an object
                // We do that by calling .done() and then rejecting in .edit()
                if (this.editing) this.done();
            }
            if (data === undefined) // New property has been added to the schema and nobody has saved since
            {
                if (!this.modes && this.value === this.templateValue) this.value = this.closestCollection ? this.default : this.templateValue;
	 ...
	 */ getValue(o) {
            if (this.editing && this.editor && this.editor !== this.element) return this.editorValue;
        ...
        setValue(value, o = {}) {
            ...
            if (!this.datatype && (typeof value == "number" || typeof value == "boolean")) this.datatype = typeof value;
            value = _.safeCast(value, this.datatype);
            if (!o.force && value === this._value && oldDatatype == this.datatype) // Do nothing if value didn't actually change, unless forced to
            return value;
            this.pauseObserver();
            if (this.editor && this.editorValue != value) // If an editor is present, set its value to match
            ...
            if (this.editType == "popup" || !this.editor || this.editor !== document.activeElement && !this.element.contains(this.editor)) {
                if (this.config.setValue) this.config.setValue.call(this, this.element, value);
                else if (!o.dataOnly) {
                    let map = this.originalEditor || this.editor;
                    let presentational;
                    if (map?.matches("select")) presentational = [
                        ...map.options
                    ].find((o)=>o.value == value)?.textContent;
            ...
            if (!o.silent) {
                if (this.saved) this.unsavedChanges = this.mavo.unsavedChanges = true;
                this.dataChanged("propertychange", {
                    value
                });
            }
        ...
        async upload(file, name = file.name) {
            ...
            if (base) // Throw away backend-provided URL and use the override instead
            ...
            if (this.mavo.uploadBackend && self.FileReader) {
                ...
                env.events = {
                    ...
                    "drop": (evt)=>{
                        ...
                        if (file && checkType(file)) this.upload(file);
                    }
                };
        ...
        static getValueAttribute(element, config = Mavo.Elements.search(element)) {
            ...
            if (!ret || ret === "null" || ret === "none") ret = null;
            return ret;
        }
        /**
	 ...
	 */ static safeCast(value, datatype) {
            ...
            if (datatype == "number") {
                if (/^[-+]?[0-9.e]+$/i.test(value + "")) return cast;
                return value;
            }
	 ...
	 */ static cast(value, datatype) {
        ...
        static getValue(element, { config , attribute , datatype  } = {}) {
            if (!config) config = _.getConfig(element, attribute);
            attribute = config.attribute;
            datatype = config.datatype;
            if (config.getValue && attribute == config.attribute) return config.getValue(element);
            var ret;
            if (attribute in element && _.useProperty(element, attribute)) // Returning properties (if they exist) instead of attributes
            // is needed for dynamic elements such as checkboxes, sliders etc
            ret = element[attribute];
            else if (attribute) ret = element.getAttribute(attribute);
            else ret = element.getAttribute("content") || _.getText(element) || null;
            return _.safeCast(ret, datatype);
        }
        static getConfig(element, attribute, datatype) {
            if (attribute === undefined) attribute = element.getAttribute("mv-attribute") || undefined;
            if (attribute == "null" || attribute == "none") attribute = null;
            var isAttributeDefault = attribute === undefined || attribute == _.getValueAttribute(element);
            if (!datatype && isAttributeDefault) datatype = element.getAttribute("datatype") || undefined;
            var config = Mavo.Elements.search(element, attribute, datatype);
            config = Object.assign({}, config);
            if (config.attribute === undefined) config.attribute = attribute || null;
            if (config.datatype === undefined) config.datatype = datatype;
            return config;
        }
        ...
        static async setValue(element, value, o = {}) {
            ...
            if ($.type(value) === "promise") {
                if (!_.pending.has(element)) _.pending.set(element, {});
                let pending = value;
                ...
                if (_.pending.get(element)[o.attribute] !== pending) // Value has been superseded
                return;
                delete _.pending.get(element)?.[o.attribute];
            }
            if (element.nodeType === 1) {
                if (!o.config) o.config = _.getConfig(element, o.attribute);
                ...
                if (o.config.setValue && o.attribute == o.config.attribute) return o.config.setValue(element, value, o.attribute);
            }
            if (value === null && !o.datatype) value = "";
            if (o.attribute) {
                if (o.attribute in element && _.useProperty(element, o.attribute) && element[o.attribute] !== value) // Setting properties (if they exist) instead of attributes
                // is needed for dynamic elements such as checkboxes, sliders etc
                try {
                ...
                if (o.datatype == "boolean") {
                    if (value != element.hasAttribute(o.attribute)) $.toggleAttribute(element, o.attribute, value, value);
                } else if (element.getAttribute(o.attribute) != value) element.setAttribute(o.attribute, value);
            } else {
                var presentational = o.presentational ?? _.format(value, o);
                if (o.node && !o.config.hasChildren) _.setText(element, presentational);
                else element.textContent = presentational;
                if (presentational !== value && element.setAttribute) element.setAttribute("content", value);
            }
        }
        /**
	 ...
	 */ static useProperty(element, attribute) {
            if ([
                "href",
                "src"
            ].indexOf(attribute) > -1) // URL properties resolve "" as location.href, fucking up emptiness checks
            return false;
            if (element.namespaceURI == "http://www.w3.org/2000/svg") // SVG has a fucked up DOM, do not use these properties
            return false;
            return true;
        }
        static format(value, o = {}) {
            ...
            if (Array.isArray(value)) return value.map(_.format).join(", ");
            if ($.type(value) === "object") // Oops, we have an object. Print something more useful than [object Object]
    ...
    $.Class(_, {
        ...
        live: {
            editor: function(value) {
                ...
                this._editor = value;
                if (this.defaultSource === "editor") this.default = this.editorValue;
                this.editorUpdated();
            },
            default: function(value) {
                if (this.value == this._default) this.value = value;
            },
            ...
            datatype: function(value) {
                if (value !== this._datatype) {
                    if (value == "boolean" && !this.attribute) this.attribute = Mavo.Elements.defaultConfig.boolean.attribute;
            ...
            lazy: {
                formatNumber: ()=>{
                    ...
                    return function(value) {
                        if (value === Infinity || value === -Infinity) // Pretty print infinity
                        return value < 0 ? "-∞" : "∞";
    ...
    Mavo.observe({
        ...
        if (node instanceof Mavo.Primitive && node.config && !node.pausedObserver) {
            if (attribute === "mv-default" && !node.defaultExpression) node.default = element.getAttribute("mv-default");
            else if (attribute === "aria-label") {
                node.label = element.getAttribute("aria-label");
                if (Mavo.in("placeholder", node.editor)) node.editor.placeholder = `(${node.label})`;
            } else if (attribute && attribute === "mv-editor") node.originalEditorUpdated();
            else if (attribute && attribute === "mv-edit-type") {
                let editing = node.editing;
                if (editing) // Undo whatever editing UI we currently have
                node.done({
                    force: true
                });
                node.updateEditType();
                if (editing) node.edit({
                    force: true
                });
            } else if (attribute && attribute.indexOf("mv-editor-") === 0) node.editor?.setAttribute(attribute.slice(10), element.getAttribute(attribute));
                ...
                if (!update && (!node.editing || node.modes === "edit")) update = attribute === node.attribute // note: these may be null
                 || node.config.observedAttributes?.includes(attribute) || type === "characterData" && !node.attribute;
                if (update) node.value = node.getValue();
            }
        }
    });
    await $.ready();
    ...
    if ($("[mv-edit]")) oldMvEdit.unshift("mv-edit");
    if (oldMvEdit.length > 0) {
        ...
        for (let name of oldMvEditUnique){
            ...
            for (let element of elements)Mavo.setAttributeShy(element, newName, element.getAttribute(name));
        }
    }
})(Bliss, Bliss.$);
(function($, $$1) {
    var _ = Mavo.UI.Popup = $.Class({
        constructor: function(primitive) {
            ...
            this.position = (evt)=>{
                ...
                var y = bounds.bottom;
                var pointDown = false;
                if (this.element.offsetHeight) // Is in the DOM, check if it fits
                ...
                events: {
                    keyup: (evt)=>{
                        if (evt.keyCode == 13 || evt.keyCode == 27) {
                            if (this.element.contains(document.activeElement)) this.primitive.element.focus();
                            evt.stopPropagation();
                            this.hide();
                        }
                    },
            ...
            if (this.editor.matches("select")) this.editor.size = Math.min(10, this.editor.children.length);
            this.hideCallback = (evt)=>{
                if (!this.element.contains(evt.target) && !this.primitive.element.contains(evt.target)) this.hide();
            };
        },
        show: function() {
            $.unbind([
        ...
        prepare: function() {
            ...
            if (!this.element.contains(this.editor)) // This can happen if edit type changes from popup to inline
    ...
    Object.defineProperties(_, {
        "register": {
            value: function(id, config) {
                ...
                if (id.indexOf("@") > -1) {
                    ...
                    if (config.attribute === undefined) config.attribute = parts[1];
                }
                config.selector = config.selector || id;
                config.id = id;
                if (Array.isArray(config.attribute)) config.attribute.forEach((attribute)=>{
                    var o = $.extend({}, config);
        ...
        "search": {
            value: function(element, attribute, datatype) {
                ...
                if (matches.length === 0 && datatype) // 0 matches, try again without datatype
        ...
        "matches": {
            value: function(element, attribute, datatype) {
                ...
                selectorloop: for(var id in _){
                    ...
                    if (!attributeMatches) continue;
                    // Passes datatype test?
                    if (datatype !== undefined && datatype !== "string" && datatype !== o.datatype) continue;
                    // Passes selector test?
                    var selector = o.selector || id;
                    if (!element.matches(selector)) continue;
                    // Passes arbitrary test?
                    if (o.test && !o.test(element, attribute, datatype)) continue;
    ...
    _.register({
        ...
        "radio": {
            ...
            initOnce: function(element) {
                function radioChanged(radio) {
                    let name = radio.name;
                    for (let otherRadio of $$1(`input[type=radio][name="${radio.name}"]`)){
                        let node = Mavo.Node.get(otherRadio, true);
                        if (node) node.value = node.getValue();
                    }
                }
                document.addEventListener("change", (evt)=>{
                    if (evt.target.matches("input[type=radio]")) radioChanged(evt.target);
                });
                Mavo.observe({
                    attribute: "value",
                    selector: "input[type=radio]"
        ...
        "block": {
            ...
            setEditorValue: function(value) {
                if (this.datatype && this.datatype != "string") value = value + "";
                var cs = getComputedStyle(this.element);
                value = value || "";
                if ([
                    "normal",
                    "nowrap"
                ].indexOf(cs.whiteSpace) > -1) // Collapse lines
                value = value.replace(/\r?\n/g, " ");
                if ([
                    "normal",
                    "nowrap",
                    "pre-line"
                ].indexOf(cs.whiteSpace) > -1) // Collapse whitespace
            ...
            init: function() {
                if (!this.fromTemplate("dateType")) {
                    ...
                    for(var type in this.config.dateTypes){
                        if (this.config.dateTypes[type].test(datetime)) break;
                    }
                    this.dateType = type;
                    if (!dateFormat) {
                        ...
                        if (dateFormat = Mavo.DOMExpression.search(this.element, null)) this.mavo.treeBuilt.then(()=>{
                            dateFormat.update();
                        });
                    }
                }
            ...
            edit: function() {
                ...
                $.bind(this.element, "click.mavo:edit keyup.mavo:edit keydown.mavo:edit", (evt)=>{
                    if (evt.type == "click" || evt.key == " " || evt.key == "Enter") {
                        if (evt.type != "keydown") this.value = !this.value;
                        evt.preventDefault();
                        evt.stopPropagation();
                    }
                });
...
(function($, $$1) {
    ...
    var _ = Mavo.Collection = class Collection extends Mavo.Node {
		 ...
		 */ this.templateElement = this.element;
            ...
            if (this.templateElement.hasAttribute("mv-like")) Mavo.warn("@mv-like is deprecated and will be removed in the next version of Mavo");
            if (this.mavo.root || !this.templateElement.hasAttribute("mv-like")) // Synchronous init
            this.init();
            else // Async init, we're borrowing the template from elsewhere so we need
        ...
        createAddButton() {
            ...
            var button = $$1(selector, group).filter((button)=>{
            ...
            if (button) {
                // Custom add button
                if (button.compareDocumentPosition(this.marker) & Node.DOCUMENT_POSITION_FOLLOWING) // Button precedes collection, make collection bottom-up if no mv-order is set
                Mavo.setAttributeShy(this.templateElement, "mv-order", "desc");
                Mavo.revocably.remove(button);
            } else button = $.create("button", {
                type: "button",
                className: "mv-ui",
        ...
        init() {
            if (!this.fromTemplate("templateElement", "accepts", "initialItems", "like", "likeNode")) {
                ...
                if (this.like) {
                    var candidates = [];
                    this.mavo.walk((obj)=>{
                        if (obj instanceof _ && obj.property === this.like && obj !== this) candidates.push(obj);
                    });
            ...
            if (this.likeNode) {
                ...
                if (!this.accepts.size) this.accepts = this.likeNode.accepts || this.accepts;
            ...
            this.mavo.treeBuilt.then(()=>{
                if (!this.initialItems) {
                    ...
                    this.element.remove();
                } else if (this.initialItems > 1) // Add extra items
        ...
        createItem(element) {
            if (!element) element = this.templateElement.cloneNode(true);
            ...
            if (!this.itemTemplate) this.itemTemplate = template || item;
            return item;
        }
        /**
	 ...
	 */ add(item, index, o = {}) {
            if (item instanceof Node) item = Mavo.Node.get(item) || this.createItem(item);
            else item = item || this.createItem();
            if (item.collection != this) {
                ...
                if (editing) this.editItem(item);
                item.render(data);
            }
            if (index === undefined) index = this.bottomUp ? 0 : this.length;
            ...
            if (this.mavo.expressions.active && !o.silent) requestAnimationFrame(()=>{
        ...
        async delete(item, { silent , undoable =!silent , transition =!silent , destroy =!undoable  } = {}) {
            ...
            if (undoable) this.mavo.setDeleted(item);
            else if (destroy) item.destroy();
            return item;
        }
        /**
	 ...
	 */ move(item, offset) {
        ...
        editItem(item, o = {}) {
            ...
            return item.preEdit.then((value)=>{
                ...
                if (!item.itembar) item.itembar = new Mavo.UI.Itembar(item);
                item.itembar.add();
                return item.edit(o);
            });
        }
        ...
        edit(o = {}) {
            ...
            if (!this.addButton.parentNode) {
                ...
                if (tag in Mavo.selectors.container) var rel = this.marker.parentNode.closest(Mavo.selectors.container[tag]);
                else if (this.bottomUp && this.children[0]) var rel = this.children[0].element;
                rel = rel || this.marker;
            ...
            if (super.done() === false) return false;
        ...
        dataRender(data, o = {}) {
            ...
            for(var i = 0; i < this.children.length; i++){
                ...
                if (i < data.length) changed = item.render(data[i], o) || changed;
                else {
                    changed = true;
                    this.delete(item, {
                        silent: true
            ...
            this.liveData.update();
            if (data.length > i) for(var j = i; j < this.children.length; j++)this.children[j].dataChanged("add");
            return changed;
        }
        isCompatible(c) {
        ...
        getDragula() {
            ...
            this.dragula = dragula({
                ...
                isContainer: (el)=>{
                    if (this.accepts.size) return Array.from(el.childNodes).some((child)=>{
            ...
            this.dragula.on("drop", (el, target, source)=>{
                ...
                var collection = _.get(previous) || _.get(next);
                var closestItem1 = Mavo.Node.get(previous) || Mavo.Node.get(next);
                if (closestItem1 && closestItem1.collection != collection) closestItem1 = null;
                if (item.collection.isCompatible(collection)) {
                    var index = closestItem1 ? closestItem1.index + (closestItem1.element === previous) : collection.length;
        ...
        static async delete(nodes, o = {}) {
            ...
            if (o.silent !== false) {
                ...
                if (o.undoable !== false) deleted.forEach((nodes, mavo)=>{
    ...
    var _ = Mavo.ImplicitCollection = class ImplicitCollection extends Mavo.Node {
        ...
        getData(o = {}) {
            ...
            this.children.forEach((node)=>{
                if (!node.isDataNull()) env.data.push(node.getData(o));
            });
            if (this.data) {
                ...
                if (rendered.length > env.data.length) env.data = env.data.concat(rendered.slice(env.data.length));
            }
            if (Array.isArray(env.data) && env.data.length <= 1) env.data = env.data.length === 1 ? env.data[0] : null;
            env.data = Mavo.subset(this.data, this.inPath, env.data);
            Mavo.hooks.run("node-getdata-end", env);
            return env.data;
        }
...
(function($, $$1) {
    var _ = Mavo.UI.Itembar = $.Class({
        constructor: function(item) {
            this.item = item;
            this.element = $$1(`.mv-item-bar:not([mv-rel]), .mv-item-bar[mv-rel="${this.item.property}"]`, this.item.element).filter((el)=>{
            ...
            if (!this.element && this.item.template?.itembar) {
                ...
                } else this.dragHandle = this.item.element;
                $.set(this.element, {
            ...
            if (this.dragHandle !== this.item.element) this.dragHandle.addEventListener("click", (evt)=>evt.target.focus());
        ...
        show: function(sticky) {
            ...
            if (this.element.hasAttribute("hidden") || sticky && !this.sticky) {
                ...
                $.bind([
                    this.item.element,
                    this.element
                ], "focusout mouseleave", this);
            }
        },
        hide: function(sticky, timeout = 0) {
            if (!this.sticky || sticky) {
                if (timeout) this.hideTimeout = setTimeout(()=>this.hide(sticky), timeout);
                else {
                    this.element.setAttribute("hidden", "");
                    $.unbind([
                        this.item.element,
        ...
        handleEvent: function(evt) {
            ...
            if (this.isWithinItem(evt.target)) {
                ...
                if ([
                    ...
                    if (!this.isWithinItem(evt.relatedTarget)) this.hide(sticky, _.DELAY);
                } else {
                    this.show(sticky);
                    evt.stopPropagation();
                }
        ...
        add: function() {
            if (!this.element.parentNode && !Mavo.revocably.add(this.element)) {
                ...
                if (tag in _.container) var rel = $(_.container[tag], this.item.element);
                (rel || this.item.element).appendChild(this.element);
            }
            if (this.dragHandle == this.item.element) this.item.element.classList.add("mv-drag-handle");
        },
        remove: function() {
            Mavo.revocably.remove(this.element);
            if (this.dragHandle == this.item.element) this.item.element.classList.remove("mv-drag-handle");
        },
        live: {
            sticky: function(v) {
...
(function() {
    var _ = Mavo.Expression = class Expression {
        ...
        eval(data = Mavo.Data.stub) {
            ...
            if (this.function instanceof Error) // Previous compilation error
            return this.function;
            try {
                return this.function(data);
            } catch (error) {
                // Runtime error
                this.error(`Something went wrong with the expression ${this.expression}`, error.message, `Data was: ${JSON.stringify(data)}`);
        ...
        live: {
            expression: function(value) {
                try {
                    ...
                    // Compilation error
                    this.error(`There is something wrong with the expression ${value}`, error.message, "Not an expression? See https://mavo.io/docs/expressions/#disabling-expressions for information on how to disable expressions.");
                ...
                if (this.ast) {
                    ...
                    Mavo.Script.walk(this.ast, (n, property, parent)=>{
                        if (n.type === "Identifier" && property !== "callee") identifiers.add(n.name);
                        else if (n.type === "MemberExpression") {
                            if (n.object.name) identifiers.add(n.object.name);
    ...
    _.Syntax = class Syntax {
        ...
        tokenize(str) {
            ...
            while((match = this.regex.exec(str)) !== null){
                ...
                if (match.index > lastIndex) ret.push(str.substring(lastIndex, match.index));
                lastIndex = this.regex.lastIndex;
                if (/\S/.test(match[1])) ret.push(new Mavo.Expression(match[1]));
                else // If the matched expression is empty or consists only of
                // whitespace, don't treat it as an expression.
                ret.push(match[0]);
            }
            // Literal at the end
            if (lastIndex < str.length) ret.push(str.substring(lastIndex));
            return ret;
        }
...
(function($, $$1) {
    var _ = Mavo.DOMExpression = $.Class({
        constructor: function(o = {}) {
            ...
            this.node = o.node;
            if (!this.node) // No node provided, figure it out from path
            ...
            if (this.attribute == "mv-value") {
                ...
                this.parsed = [
                    new Mavo.Expression(expression)
                ];
            ...
            _.special.add(this);
            this.mavo.treeBuilt.then(()=>{
                if (!this.template && !this.item) // Only collection items and groups can have their own expressions arrays
                this.item = Mavo.Node.getClosestItem(this.element);
                if (this.originalAttribute == "mv-value" && this.mavoNode && this.mavoNode == this.item.collection) Mavo.delete(this.item.expressions, this);
        ...
        changedBy: function(evt) {
            if (this.isDynamicObject) // Just prevent the same node from triggering changes, everything else is game
        ...
        update: function() {
            ...
            } else var data = this.data === undefined ? Mavo.Data.stub : this.data;
            ...
            env.value = this.value = this.parsed.map((expr, i)=>{
                if (expr instanceof Mavo.Expression) {
                    ...
                    changed = true;
                    if (env.value instanceof Error) return this.fallback !== undefined ? this.fallback : this.syntax.start + env.expr.expression + this.syntax.end;
                    if (env.value === undefined || env.value === null) // Don’t print things like "undefined" or "null"
                    return "";
                    return env.value;
                }
                return expr;
            });
            if (!changed) // If nothing changed, no need to do anything
            return;
            if (env.value.length === 1) env.value = env.value[0];
            else env.value = env.value.map((v)=>Mavo.Primitive.format(v, {
                    attribute: this.attribute,
                    element: this.element
                })).join("");
        ...
        output: function(value) {
            if (this.primitive) {
                if (Mavo.in(Mavo.isProxy, value)) value = Mavo.clone(value); // Drop proxy
                this.primitive.value = value;
            } else if (this.mavoNode) this.mavoNode.render(value);
            else Mavo.Primitive.setValue(this.node, value, {
                attribute: this.attribute
            });
        },
        live: {
            item: function(item) {
                if (item && this._item != item) {
                    if (this._item) // Previous item, delete from its expressions
		 ...
		 */ search: function(element, attribute) {
                ...
                if (attribute && !element.ownerDocument.xmlVersion) attribute = attribute.toLowerCase();
            ...
            special: {
                add: function(domexpression, name) {
                    if (name) {
                        ...
                        if (o && (hasName || hasUnprefixedName)) {
                            ...
                            if (o.all.size === 1) o.observe();
                            else if (!o.all.size) o.unobserve();
                        }
                    } else // All names
                    for(var name in this.vars)this.add(domexpression, name);
                },
                delete: function(domexpression, name) {
                    if (name) {
                        ...
                        if (!o.all.size) o.unobserve();
                    } else // All names
                    for(var name in this.vars)this.delete(domexpression, name);
                },
                update: function() {
                ...
                event: function(name, { type , update , target =document  } = {}) {
                    ...
                    if (update) this.vars[name].update = function(evt) {
    ...
    var _ = Mavo.Expressions = $.Class({
        ...
        register: function(domexpression) {
            ...
            domexpression.identifiers.forEach((id)=>{
                if (!(ids[id] instanceof Set)) ids[id] = new Set();
        ...
        unregister: function(domexpression) {
            var ids = this.identifiers;
            domexpression.identifiers.forEach((id)=>{
                if (ids[id]) ids[id].delete(domexpression);
                // just in case domexpresssion has been destroyed by another app during the loop
                // when another app is destroyed.
                if (id in Mavo.all && typeof domexpresssion !== "undefined") // Cross-mavo expressions
        ...
        updateThrottled: function(evt) {
            ...
            if (evt.node.template) // Throttle events in collections and events from other Mavos
            {
            ...
            } else requestAnimationFrame(()=>this.update(evt));
        },
        update: function(evt) {
            if (!this.active) return;
            var root, rootObject;
            if (evt instanceof Mavo.Node) rootObject = evt;
                ...
                if (evt.action == "propertychange") {
                    if (evt.node?.path) // Ensure that [collectionName] updates when changing children
                ...
                return;
            } else rootObject = this.mavo.root;
            rootObject.walk((obj, path)=>{
                if (!obj.expressionsEnabled) return false;
                obj.expressions?.forEach((et)=>{
                    // Prevent mv-value loops
                    if (!evt || et.mavoNode !== evt) et.update();
                });
            });
        },
        updateByIdThrottled: function(property, evt, cache) {
            if (!property) return;
            if (property.forEach) property.forEach((property)=>this.updateByIdThrottled(property, evt, cache));
            else {
        ...
        updateById: function(property, evt, cache) {
            ...
            if (exprs) exprs.forEach((expr)=>{
                // Prevent the same node from triggering changes, everything else is game
                if (expr.originalAttribute == "mv-value" && expr.mavoNode && !(expr.mavoNode instanceof Mavo.Primitive) && expr.mavoNode.contains(evt.node)) return;
                if (!cache.updated.has(expr)) expr.update();
            });
        },
        extract: function(node, attribute, path, syntax = Mavo.Expression.Syntax.default) {
            if (attribute && _.skip.indexOf(attribute.name) > -1) return;
            if (attribute && _.directives.indexOf(attribute.name) > -1 || syntax !== Mavo.Expression.Syntax.ESCAPE && syntax.test(attribute ? attribute.value : node.textContent)) {
                if (path === undefined) path = Mavo.elementPath(node.closest(Mavo.selectors.item), node);
        ...
        traverse: function(node, path = [], syntax) {
            if (node.nodeType === 8) // We don't want expressions to be picked up from comments!
            // Commenting stuff out is a common debugging technique
            return;
            if (node.nodeType === 3) // Leaf node, extract references from content
            this.extract(node, null, path, syntax);
            else {
                node.normalize();
                syntax = Mavo.Expression.Syntax.create(node) || syntax;
                if (Mavo.is("item", node)) path = [];
                if (node.hasAttribute("mv-expressions-ignore")) var ignore = new Set(node.getAttribute("mv-expressions-ignore").trim().split(/\s*,\s*/));
                $$1(node.attributes).forEach((attribute)=>{
                    if (!ignore || !ignore.has(attribute.name)) this.extract(node, attribute, path, syntax);
                });
                var index = -1, offset = 0;
                if (!node.matches("script:not([mv-expressions])")) $$1(node.childNodes).forEach((child)=>{
                    if (child.nodeType == 1) {
                        offset = 0;
                        index++;
                    } else offset++;
            ...
            "DOMExpression": {
                lazy: {
                    "childProperties": function() {
                        var properties = $$1(Mavo.selectors.property, this.element).filter((el)=>el.closest("[mv-if]") == this.element).map((el)=>Mavo.Node.get(el));
                        ...
                        this.element.addEventListener("mv-change", (evt)=>{
                            ...
                            requestAnimationFrame(()=>{
                                if (!this.element.parentNode) this.item.element.dispatchEvent(evt);
                            });
                        });
                        return properties;
                    }
        ...
        hooks: {
            ...
            "domexpression-update-end": async function() {
                ...
                if (parentValue !== false) {
                    if (value) // Is removed from the DOM and needs to get back
                    Mavo.revocably.add(this.element);
                    else if (this.element.parentNode) // Is in the DOM and needs to be removed
 ...
 */ (function($, val) {
	 ...
	 */ get: function(obj, property, meta = {}) {
            ...
            if (canonicalProperty !== undefined) {
                ...
                if (typeof ret === "function" && ret.name.indexOf("bound") !== 0) return ret.bind(obj);
                return ret;
            }
            if (Array.isArray(obj) && property && isNaN(property)) {
                ...
                if (eqIndex > -1) {
                    ...
                    ret = obj.filter((e, i)=>{
                        ...
                        if (passes) meta.property.push(i);
                        return passes;
                    });
                    ...
                    if (ret === undefined) meta.property = obj.length;
                    else if (ret.length === 0) meta.property = [
                        obj.length
                    ];
                    return ret;
                } else // Not a property query, get from objects inside
                // TODO meta.property = ??
        ...
        url: (id, url = location)=>{
            if (id === undefined) return location.href;
            if (id) {
                id = str(id).replace(/[^\w-:]/g);
                var ret = url.search.match(RegExp(`[?&]${id}(?:=(.+?))?(?=$|&)`)) || url.pathname.match(RegExp(`(?:^|\\/)${id}\\/([^\\/]*)`));
            }
            if (ret === null || !id) return null;
        ...
        first: (n, arr)=>{
            ...
            if (!Array.isArray(arr)) return n !== undefined ? [
                arr
            ] : arr;
            if (n < 0) return _.last(Math.abs(n), arr);
            else {
                var ret = [];
                var numReturn = n === undefined ? 1 : Math.floor(n);
                for(var i = 0; i < arr.length && ret.length < numReturn; i++)if (Mavo.value(arr[i]) !== null) ret.push(arr[i]);
                if (n === undefined) return ret[0] !== undefined ? ret[0] : null;
                return ret;
            }
        },
        last: (n, arr)=>{
            ...
            if (n < 0) return _.first(Math.abs(n), arr);
            else {
                var ret = [];
                var numReturn = n === undefined ? 1 : Math.floor(n);
                for(var i = arr.length - 1; i >= 0 && ret.length < numReturn; i--)if (Mavo.value(arr[i]) !== null) ret.push(arr[i]);
                if (n === undefined) return ret[0] !== undefined ? ret[0] : null;
                return ret;
            }
        },
	 ...
	 */ max: $.extend(function(array) {
        ...
        round: $.extend((num, decimals)=>{
            if (not(num) || not(decimals) || !isFinite(num)) return Math.round(num);
        ...
        digits: $.extend((digits, decimals, num)=>{
            ...
            if (decimals !== undefined && parts[1]) parts[1] = parts[1].slice(0, decimals);
            num = +parts.join(".");
        ...
        iff: function(condition, iftrue = condition, iffalse = null) {
            if (Array.isArray(condition)) return condition.map((c, i)=>{
        ...
        range: (a, b, step)=>{
            ...
            if (steps <= 0 || !isFinite(steps)) return [
                a
            ];
            let ret = [];
	 ...
	 */ replace: $.extend((haystack, needle, replacement = "", iterations = 1)=>{
            if (Array.isArray(haystack)) return haystack.map((item)=>_.replace(item, needle, replacement));
	 ...
	 */ contains: $.extend((haystack, needle)=>{
            ...
            if ($.type(needle) === "object") return JSON.stringify(haystack).indexOf(JSON.stringify(needle)) >= 0;
            if (haystackType === "object" || haystackType === "array") for(let property in haystack){
                ret = _.contains(haystack[property], needle);
                if (Array.isArray(ret)) ret = Mavo.Functions.or(ret);
                if (ret) return true;
            }
            else return _.search(haystack, needle) >= 0;
            return ret;
        }, {
            multiValued: true
        }),
	 ...
	 */ search: $.extend((haystack, needle)=>{
        ...
        util: {
            numbers: function(array, args) {
                array = Array.isArray(array) ? array : args ? $$(args) : [
                    array
                ];
            ...
            postProcess: function(callback) {
                ...
                var newCallback;
                if (multiValued === true || multiValued?.length === 2) newCallback = (...args)=>{
                    ...
                    return Mavo.Script.binaryOperation(args[idxA], args[idxB], {
                        scalar: (a, b)=>{
                            ...
                            if (idxA in args) args[idxA] = a;
                            if (idxB in args) args[idxB] = b;
                            return callback(...args);
                        },
                        ...callback
                    });
                };
                else if (callback.isAggregate) newCallback = function(array) {
                    if (Mavo.in(Mavo.groupedBy, array)) return array.map((e)=>newCallback(e.$items));
                ...
                if (callback.alias) for (let alias of Mavo.toArray(callback.alias))Mavo.Functions[alias] = newCallback || callback;
                return newCallback;
            }
        }
    };
 ...
 */ Mavo.ready.then(()=>{
        Object.getOwnPropertyNames(Mavo.Functions).forEach((property)=>{
            ...
            if (newCallback) Mavo.Functions[property] = newCallback;
        });
        // Deal with Math functions that have 1 argument
        Object.getOwnPropertyNames(Math).forEach((property)=>{
            if (Math[property].length === 1 && !Mavo.Functions.hasOwnProperty(property)) Mavo.Functions[property] = (operand)=>Mavo.Script.unaryOperation(operand, (operand)=>Math[property](operand));
        });
    });
    /**
 ...
 */ (function($, val, _, $u = _.util) {
    ...
    for(let unit in s)_[unit] = $.extend(function(ms) {
        if (arguments.length === 0) return s[unit] * 1000;
        return _.msTo(unit, ms);
    }, {
        multiValued: true
    });
    _.duration = $.extend(function(ms, terms) {
        if (ms === 0 || terms === undefined) terms = 1;
        let timeLeft = ms || 0;
        let ret = [];
        if (ms < 1) ret = [
            "0 ms"
    ...
    $.extend(_.util, {
        fixDateString: function(date) {
            ...
            // Fix up time format
            if (!hasDate) // No date, add today’s
            date = _.$today + " " + date;
            else // Only year-month, add day
            date = date.replace(/^(\d{4}-\d{2})(?!-\d{2})/, "$1-01");
            if (!hasTime) // Add a time if one doesn't exist
            date += "T00:00:00";
            else // Make sure time starts with T, due to Safari bug
        ...
        dateComponent: function(component, date, format) {
            if (arguments.length === 1 && component + "s" in s) return _[component + "s"]();
            ...
            if (format) {
                if (/^0+$/.test(format)) // Leading zeroes
        ...
        date: function(date) {
            ...
            if ($.type(date) !== "string" || !isNaN(object) && object + "" == date) return object;
            date = $u.fixDateString(date);
            if (date === null) return null;
            var timezone = date.match(/[+-]\d{2}:?\d{2}|Z$/)?.[0];
            if (timezone) // parse as ISO format
            date = new Date(date);
            else {
...
(function($, val, $u) {
    var _ = Mavo.Script = {
        $fn: self.Proxy ? new Proxy({
            ...
            get: (data, property)=>{
                ...
                if (propertyL in Mavo.Actions.Functions) {
                    if (Mavo.Actions.running) ret = Mavo.Actions.Functions[propertyL];
                    else ret = Mavo.Actions.nope;
                }
                // Is this a Mavo function?
                if (ret === undefined) {
                    if (propertyL in Mavo.Functions) ret = Mavo.Functions[propertyL];
                    else // Maybe it's a Math function?
        ...
        addUnaryOperator: function(name, o) {
            if (o.symbol) // Build map of symbols to function names for easy rewriting
        ...
        unaryOperation: function(operand, scalar) {
            if (Array.isArray(operand)) return operand.map(scalar);
            else return scalar(operand);
        },
        binaryOperation: function(a, b, o = {}) {
            ...
            if (Array.isArray(b)) {
                if (Array.isArray(a)) {
                    ...
                    for(let i = 0; i < max; i++){
                        if (o.comparison && (a[i] === undefined || b[i] === undefined)) result[i] = o.default;
                        else if (a[i] === undefined) result[i] = rightUnary ? rightUnary(b[i]) : o.scalar(leftDefault, b[i]);
                        else if (b[i] === undefined) result[i] = leftUnary ? leftUnary(a[i]) : o.scalar(a[i], rightDefault);
                        else result[i] = o.scalar(a[i], b[i]);
                    }
                } else result = b.map((n)=>o.scalar(a, n));
            } else if (Array.isArray(a)) result = a.map((n)=>o.scalar(n, b));
            else result = o.scalar(a, b);
            return result;
        },
        /**
	 ...
	 */ addBinaryOperator: function(name, o) {
            ...
            Mavo.toArray(o.symbol).forEach((symbol)=>{
                ...
                if (o.precedence) jsep.addBinaryOp(symbol, o.precedence);
            });
            o.default = o.default === undefined ? 0 : o.default;
            return o.code || function(...operands) {
                if (operands.length === 1) {
                    if (Array.isArray(operands[0])) // Operand is an array of operands, expand it out
                    operands = [
                        ...operands[0]
                    ];
                }
                if (!o.raw) operands = operands.map(val);
                var prev = o.comparison ? true : operands[0], result;
                for(let i = 1; i < operands.length; i++){
                    let a = o.comparison ? operands[i - 1] : prev;
                    let b = operands[i];
                    if (Array.isArray(b) && typeof o.default == "number") b = $u.numbers(b);
                    var result = _.binaryOperation(a, b, o);
                    if (o.comparison) prev = _.binaryOperation(prev, result, _.operators["and"]);
                    else prev = result;
                }
                return prev;
            };
	 ...
	 */ symbols: {},
        ...
        isStatic: (node)=>{
            ...
            for (let property of _.childProperties)if (node[property] && property !== "callee") {
                if (!_.isStatic(node[property])) return false;
            }
            return true;
        },
        /**
	 ...
	 */ operators: {
            ...
            "filter": {
                symbol: "where",
                code: (a, ...filters)=>{
                    for (let b of filters)if (Array.isArray(a)) {
                        if (Array.isArray(b)) a = a.map((v, i)=>val(b[i]) ? v : null);
                        else {
                            b = val(b);
                            if (typeof b === "boolean") // foo where true/false should equal foo/null respectively
                            a = b ? a : a.map((v)=>null);
                            else // foo where 5 should equal foo where foo = 5
                ...
                postFlattenTransformation: (node)=>{
                    ...
                    for(let i = 1; i < node.arguments.length; i++)if (!_.isStatic(node.arguments[i])) node.arguments[i] = Object.assign(_.parse("scope()"), {
                        arguments: [
                            object,
                            node.arguments[i]
                        ]
            ...
            "has": {
                ...
                code: function(needle, ...haystacks) {
                    ...
                    haystacks.map((b)=>{
                        ...
                        else if ($.type(b) === "object") // Mimic JS' in operator
            ...
            "groupby": {
                ...
                code: (array, key)=>{
                    ...
                    if (Mavo.in(Mavo.route, array)) ret[Mavo.route] = Object.assign({}, array[Mavo.route]);
                    groups.forEach((items, value)=>{
                        ...
                        if (Mavo.in(Mavo.route, array)) {
                            ...
                            obj[Mavo.route] = $.each(items[Mavo.route], (p, v)=>new Set([
                                    "$items"
                                ]));
                        }
                        ret.push(obj);
	 ...
	 */ walk: function(node, callback, o = {}, property, parent) {
            if (!o.type || node.type === o.type) var ret = callback(node, property, parent);
            if (!o.ignore || o.ignore.indexOf(node.type) === -1) {
                if (Array.isArray(node)) for (let n of node)_.walk(n, callback, o, property, node);
                else _.childProperties.forEach((property)=>{
                    if (node[property]) _.walk(node[property], callback, o, property, node);
                });
            }
            if (ret !== undefined && parent) // Apply transformations after walking, otherwise it may recurse infinitely
            parent[property] = ret;
            return ret;
        },
        /**
	 ...
	 */ serializers: {
            ...
            "CallExpression": (node)=>{
                ...
                if (node.callee.type === "MemberExpression") {
                    if (node.callee.property.type === "Identifier" && node.callee.property.name === "call") callee = node.callee.object;
                }
                if (root.type === "Identifier") {
                    // Clashes with native prototype methods? If so, look first in Function trap
                    var name = root.name;
                    if (name === "scope") return _.serializeScopeCall(node.arguments);
                    else if (name in Mavo.Script.$fn) parent[prop] = {
            ...
            "MemberExpression": (node, parent)=>{
                ...
                do {
                    if (n.type === "CallExpression" && n.callee === pn) break;
                    pn = n;
                }while (n = n.parent);
                if (n) {
	 ...
	 */ transformations: {
            "BinaryExpression": (node)=>{
                ...
                if (def.comparison) {
                    ...
                    for(let i = 0; i < comparisonOperands.length - 1; i++)if (comparisonOperands[i].comparison != comparisonOperands[i + 1].comparison) {
                    ...
                    } else comparisonOperands.forEach((co)=>{
                        ret.arguments.push(co.operand);
                    });
                } else {
            ...
            "CallExpression": (node)=>{
                if (node.callee.type == "Identifier") {
                    ...
                    } else if (node.callee.name == "delete") node.callee.name = "clear";
                    else {
        ...
        serialize: (node, parent)=>{
            if (typeof node === "string") return node; // already serialized
            if (parent) node.parent = parent;
            var ret = _.transformations[node.type]?.(node, parent);
            if (typeof ret == "object" && ret?.type) node = ret;
        ...
        compile: function(code, o) {
            if (!/\S/.test(code)) // If code contains only whitespace, including in particular if
	...
	with (data || {}) {
		...
		return (${code});
            ...
            if (o?.actions) // Yes this is a horrible, horrible hack and I’m truly ashamed.
...
Mavo.Actions.running = Mavo.Actions._running;`;
    ...
    for(let name in _.operators){
        ...
        if (details.scalar?.length < 2) var ret = _.addUnaryOperator(name, details);
        else var ret = _.addBinaryOperator(name, details);
        details.code = details.code || ret;
        if (ret && details.export !== false) Mavo.Functions[name] = ret;
    }
...
(function($, $$1) {
    ...
    var _ = Mavo.Actions = {
        listener: (evt)=>{
            ...
            if (!element) return; // Not an action
            var node = Mavo.Node.get(element);
            if (node && node.editing && node.modes !== "edit") // If this is a node, and being edited (and supports other modes), we don't want to have the action interfering.
            return;
            if (evt.type === "submit") evt.preventDefault();
            if (element) _.run(element.getAttribute("mv-action"), element, evt);
        },
        ...
        getNode: (node)=>{
            ...
            else if (node?.[Mavo.toNode]) return node[Mavo.toNode];
        },
        getCollection: (ref)=>{
            var collection = _.getNode(ref);
            if (collection instanceof Mavo.Collection) return collection;
		 ...
		 */ add: function(data, ref, index) {
                if (arguments.length < 3) {
                    if (arguments.length <= 1) // add(ref) signature used
                    [data, ref] = [
                        undefined,
                        data
                    ];
                        ...
                        if (!collection) {
                            ...
                            if (collection) // Yup, it's (ref, index)
                            [data, ref, index] = [
                                undefined,
                                data,
                                ref
                ...
                if (index === undefined) {
                    ...
                    var node = _.getNode(ref);
                    if (node !== collection) index = node.index;
                }
                return (Array.isArray(data) ? data : [
                    data
                ]).map((datum)=>{
                    var item = collection.add(undefined, index);
                    if (datum !== undefined) item.render(datum);
                    if (collection.editing) collection.editItem(item);
		 ...
		 */ move: (from, to, index)=>{
                ...
                if ($.type(to) == "number" && !toNode?.collection) // If to is a number and not a collection item, it's an index
                [index, to] = [
                    to
                ];
		 ...
		 */ clear: (...ref)=>{
                ...
                nodes.forEach((node)=>{
                    if (!node) return;
                    if (node instanceof Mavo.Collection) // Clear collection
                    itemsToDelete.push(...node.children);
                    else if (node.collection) // Collection item, delete
                    itemsToDelete.push(node);
                    else // Ordinary node, just clear its data
                    node.walk((n)=>{
                        if (n instanceof Mavo.Primitive) n.value = null;
                        else if (n !== node) _.clear(n);
                    });
                });
		 ...
		 */ set: (ref, values)=>{
                if (!ref) return;
                var node = _.getNode(ref);
                if (node) // Single node, render values on it
                node.render(values);
                else {
                    var wasArray = Array.isArray(ref);
                    var nodes = _.getNodes(ref);
                    if (!nodes.length) Mavo.warn(`The first parameter of set() needs to be one or more existing properties, ${Mavo.safeToJSON(ref)} is not.`);
                    else Mavo.Script.binaryOperation(wasArray ? nodes : nodes[0], values, {
                        scalar: (node, value)=>{
    ...
    for(let name in _.Functions){
        let nameif = name + "if";
        if (!(nameif in _.Functions)) _.Functions[nameif] = (condition, target, ...rest)=>{
    ...
    var _ = Mavo.Data = $.Class(class Data {
        ...
        update() {
            if (this.node instanceof Mavo.Collection || this.node instanceof Mavo.ImplicitCollection) {
                ...
                this.data.length = 0;
                for(var i = 0; i < this.node.children.length; i++)this.data[i] = this.node.children[i].liveData.data;
                ...
                if (Mavo.isPlainObject(value) || Array.isArray(value)) // Object rendered on a primitive, we should traverse it and store its properties
                ...
                else _.computeMetadata(this.data, this.key, this.parent);
                this.updateParent();
            }
        }
        updateParent() {
            ...
            } else if (this.collection instanceof Mavo.ImplicitCollection) // Is implicit collection *Item*
            this.parent.update();
            else {
                var key = this.key, isDeleted = false;
                if (this.collection instanceof Mavo.Collection) // Is collection item, check if deleted
                isDeleted = this.collection.children[this.node.index] !== this.node;
                if (key !== undefined && !isDeleted) this.parent.set(key, this.data, true);
            }
        }
        ...
        updateKey() {
            ...
            if (this.parent[oldKey] === this.data) delete this.parent[oldKey];
            this.updateParent();
        }
        resolve(property) {
        ...
        static: {
            ...
            stub: self.Proxy ? new Proxy({
                ...
                get: (data, property)=>{
                    ...
                    if (ret !== undefined || typeof property !== "string") return ret;
                    var propertyL = property.toLowerCase();
                    if (propertyL[0] === "$" && propertyL in Mavo.Functions) // Non-data $specialProperty
                    return Mavo.Functions[propertyL];
                    else {
                        var propertyU = property.toUpperCase();
                        if (propertyU in Math) // Math constants
                        return Math[propertyU];
                    }
                    // Still not found? Maybe it's a global
                    if (typeof window !== "undefined" && window.hasOwnProperty(property)) // hasOwnProperty to avoid elements with ids clobbering globals
                    return window[property];
                    // Still not found? Maybe it's a special property used without a $ (see #343)
                    if (property[0] !== "$") {
                        var $property = "$" + property.toLowerCase();
                        if ($property in Mavo.Functions) return Mavo.Functions[$property];
                    }
            ...
            find (property, data, o = {}) {
                if (!data || o.exclude === data) return;
                if (Mavo.in(property, data) && o.exclude !== data[property]) return data[property];
                if (!data[Mavo.route] || !Mavo.in(property, data[Mavo.route])) {
                    if (data[Mavo.property] === property) return data;
                    if (_.isItem(data) && _.getProperty(data) === property) // Inside collection items we want their property name
                ...
                var findDown = (prop)=>{
                    ...
                    if (ret !== undefined) {
                        ...
                        if (Mavo.in(Mavo.route, ret)) for(var p in ret[Mavo.route])results[Mavo.route][p] = true;
                ...
                if (Array.isArray(data) || data[Mavo.route][property] === true) for(var prop in data)findDown(prop);
            ...
            resolve (property, data) {
                if (property === Mavo.isProxy) return true;
                if (typeof property === "symbol") // We can't do much for symbols
                ...
                if (property in data) ret = data[property];
                    ...
                    if (property in _.special) ret = _.special[property](data);
                        ...
                        if (Mavo.in(property, all)) ret = _.findUp(property, data);
                    } else if (Mavo.in(Mavo.route, data) && Mavo.in(property, data[Mavo.route])) ret = _.find(property, data);
                }
                ...
                if (!propertyIsNumeric) {
                    ...
                    if (isNaN(property) && Mavo.all?.[property]?.root) return Mavo.all[property].root.getLiveData();
                    // Still not found? Maybe it's a special property used without a $ (see #343)
                    if (property[0] !== "$") {
            ...
            has (property, data) {
                ...
                if (property === Mavo.isProxy) return true;
                if (typeof property !== "string") return Reflect.has(data, property);
                var objects = [
                    data,
                    Mavo.all,
                    _.special
                ];
                if (objects.some((obj)=>property in obj)) return true;
                if (typeof property === "string") {
                    var propertyL = property.toLowerCase();
                    if (propertyL !== property && objects.some((obj)=>propertyL in obj)) return true;
                    if (propertyL[0] !== "$" && "$" + propertyL in _.special) return true;
                }
                // Slowest search last: Is the property present anywhere in the data?
                if (data[Mavo.mavo]) return Mavo.in(property, data[Mavo.mavo].root.liveData.data[Mavo.route]);
            },
            proxify (data) {
                if (!data || typeof data !== "object" || !self.Proxy || data[Mavo.isProxy]) // Data is a primitive, proxies are not supported, or is already a proxy
                return data;
            ...
            computeMetadata (object, property, parent) {
                if (object && typeof object === "object") {
                    if (property !== undefined) object[Mavo.property] = property;
                    if (parent && !object[Mavo.parent]) object[Mavo.parent] = parent;
                }
            },
            computeRoute (object, property, parent) {
                ...
                if (Mavo.isPlainObject(object) === Object.prototype || Array.isArray(object)) {
                    if (!object[Mavo.route]) object[Mavo.route] = {};
                }
                if ($.type(property) !== "number") {
                    var child = object;
                    while(parent){
                        if (!parent[Mavo.route]) parent[Mavo.route] = {};
                        // parent[up] = child
                        var up = child?.[Mavo.property];
                        if (up && parent[Mavo.route][property] !== true) {
                            if (!parent[Mavo.route][property]) parent[Mavo.route][property] = new Set();
                            if (parent[Mavo.route][property].has(up)) break;
                            parent[Mavo.route][property].add(up);
                        } else parent[Mavo.route][property] = true;
                        child = parent;
                        parent = parent[Mavo.parent];
                    }
                }
            ...
            traverseDown (callback, object, property, parent) {
                if (Array.isArray(object)) object.forEach((item, i)=>_.traverse(callback, item, i, object));
                else if ($.type(object) === "object") for(var prop in object)_.traverse(callback, object[prop], prop, object);
            },
            ...
            special: {
                $index: function(obj) {
                    var closestItem1 = _.closestItem(obj).value;
                    if (!closestItem1) return -1;
                    var property = closestItem1[Mavo.property];
                    if (isNaN(property)) // Is an array item but its property is not a number! Search the array.
                    // This happens with Implicit Collections of only 1 item.
                    return closestItem1[Mavo.parent].indexOf(closestItem1);
                    return property;
                },
                $item: function(obj) {
...
(function($, $$1) {
    let _ = Mavo.Backend.register($.Class({
        ...
        get: async function(url) {
            if (this.isAuthenticated() || !this.path || url) {
                ...
                if (info.apiData) // GraphQL
                return this.request(info.apiCall, info.apiData, "POST").then((response)=>{
                    if (response.errors?.length) return Promise.reject(response.errors.map((x)=>x.message).join("\n"));
	 ...
	 */ put: function(serialized, path = this.path, o = {}) {
            if (!path) // Raw API calls are read-only for now
            return;
            ...
            return repoInfo.then((repoInfo)=>{
                if (!this.canPush()) // Does not have permission to commit, create a fork
                return this.request(`${repoCall}/forks`, {
                    name: this.repo
                }, "POST").then((forkInfo)=>{
                    ...
                    let test = (resolve, reject)=>{
                        ...
                        this.request(`repos/${forkInfo.full_name}/commits`, {
                ...
                return this.request(fileCall, {
                    ...
                    if (xhr.status == 404) // File does not exist, create it
                    return this.request(fileCall, {
        ...
        login: function(passive) {
            return this.oAuthenticate(passive).then(()=>this.getUser()).catch((xhr)=>{
                if (xhr.status == 401) // Unauthorized. Access token we have is invalid, discard it
                this.logout();
            }).then((u)=>{
                if (this.user) {
                    this.permissions.on("logout");
                    if (this.info.path) this.permissions.on([
                        "edit",
                        "save"
                    ]);
                    if (this.repo) return this.request(`repos/${this.username}/${this.repo}`).then((repoInfo)=>{
                        if (this.branch === undefined) this.branch = repoInfo.default_branch;
                            ...
                            if (!this.canPush()) {
                                if (this.user.info.public_repos < repoInfo.forks) {
                                    ...
                                    return this.request("https://api.github.com/graphql", {
                                        ...
                                        for(let i in repos)if (repos[i].parent.nameWithOwner === repoInfo.full_name) {
                                            this.switchToMyForkDialog(repos[i].url);
                                            return repoInfo;
                                        }
                                        return repoInfo;
                                    });
                                } else return this.request(repoInfo.forks_url).then((forks)=>{
                                    for(let i in forks)if (forks[i].owner.login === this.user.username) {
        ...
        canPush: function() {
            if (this.repoInfo) return this.repoInfo.permissions.push;
		 ...
		 */ parseURL: function(source, defaults = {}) {
                ...
                Object.defineProperties(ret, {
                    ...
                    "path": {
                        get () {
                            if (this.filename) return (this.filepath ? this.filepath + "/" : "") + this.filename;
                ...
                if (/raw.githubusercontent.com$/.test(url.host)) ret.branch = path.shift();
                ...
                } else // If we work with a raw API call and couldn't find the filename in the path,
...
console.log("local"); //# sourceMappingURL=maps/mavo-nodeps.js.map
 //# sourceMappingURL=maps/mavo.js.map

//# sourceMappingURL=index.d6f65ae9.js.map
