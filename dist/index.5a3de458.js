 ...
 */ let Tabs = function(e) {
    let n = document.getElementById(e.elem), a = e.open || 0, r = "js-tabs__title", c = "js-tabs__title-active", l = "js-tabs__content", o = n.querySelectorAll("." + r).length;
    function t(e) {
        n.addEventListener("click", i);
        for(let t = u(null == e ? a : e), l = 0; l < o; l++)n.querySelectorAll("." + r)[l].setAttribute("data-index", l), l === t && f(l);
    }
    function i(e) {
...
//# sourceMappingURL=index.5a3de458.js.map
